...
export function ParcelDetailPanel({ parcel, onClose, onLocate }: Props) {
  ...
  async function refreshMemoryMusicUrl() {
    ...
    if (error) { setMemoryMessage(`Müzik açılamadı: ${error.message}`); return; }
