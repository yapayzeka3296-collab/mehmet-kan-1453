...
function pos(i:number,total:number,radius:number){const a=total>1?(i/total)*Math.PI*2:0;const ring=Math.floor(i/40);const r=radius+ring*4.5;return{left:50+Math.cos(a)*r,top:50+Math.sin(a)*r*.72};}
