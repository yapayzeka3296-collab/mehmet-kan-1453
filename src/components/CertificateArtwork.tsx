...
const LAYOUT = {
  ...
  qr: { right: 10.5, top: 57.5, size: 10.8 },
      ...
      <div className="relative">
        ...
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute left-[27.5%] top-[43.5%] flex h-[7%] w-[45%] items-center justify-center text-center">
            <span style={{ fontFamily: NAME_FONT, fontStyle: "normal", fontWeight: 400, letterSpacing: "-0.01em" }} className="text-[clamp(16px,4.5vw,69px)] leading-none text-[#c79b38] drop-shadow-[0_1px_2px_rgba(0,0,0,.22)]">{displayName}</span>
          </div>
          ...
          {verificationQr && (
            <div className="absolute right-[10.5%] top-[57.5%] flex aspect-square w-[10.8%] items-center justify-center overflow-hidden rounded-[2px] bg-transparent p-0">
