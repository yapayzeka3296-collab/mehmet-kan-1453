...
function Sertifikalarim() {
  ...
  const loadCertificates = useCallback(async () => {
    ...
    if (queryError) { console.error("Certificate query failed", queryError); setError("Sertifika kayıtları yüklenemedi."); }
      ...
      <main className="mx-auto grid max-w-[1600px] gap-6 px-4 py-8 lg:grid-cols-[260px_1fr] lg:px-8">
        ...
        <div className="min-w-0">
          <div className="panel flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div><h1 className="font-display text-3xl font-bold">SERTİFİKALARIM</h1><p className="mt-2 text-xs text-muted-foreground">MySkyParcel sertifikalarınız, doğrulama bilgileri ve güncel şablonlarıyla birlikte burada saklanır.</p></div>
            <div className="flex flex-wrap gap-2">
              <Link to="/sertifika-talep" className="btn-gold rounded-md px-3 py-2 text-xs">SERTİFİKA TALEP ET</Link>
