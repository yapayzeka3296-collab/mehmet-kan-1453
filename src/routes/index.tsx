        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto grid max-w-[1600px] gap-10 px-4 py-14 xl:grid-cols-[1.05fr_0.75fr] xl:px-8 xl:py-20">
            <div className="min-w-0">
              ...
              <div className="mt-10 inline-flex max-w-full items-center gap-2 rounded-md bg-navy-deep/70 px-4 py-2"><MapPin className="h-5 w-5 shrink-0 text-gold" /><span className="text-sm font-semibold">{HERO_LOCATION.city} <span className="block text-[10px] text-muted-foreground">{HERO_LOCATION.district}</span></span></div>
            </div>
            ...
            <div className="panel min-w-0 border-2 border-gold/50 p-5">
              <div className="rounded-lg border border-gold/40 p-5 text-center">
                ...
                <p className="mt-4 text-[10px] tracking-[0.2em] text-muted-foreground">PARSEL KODU</p><p className="break-all font-display text-2xl text-gold">GZT-K05-S042-P07</p>
