          ...
          <div className="relative mx-auto grid max-w-[1600px] gap-10 px-4 py-14 lg:grid-cols-[1.05fr_0.75fr] lg:px-8 lg:py-20">
            <div className="min-w-0">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <button className="inline-flex items-center gap-2 rounded-md border border-border px-6 py-3 text-xs tracking-[0.08em] transition-colors hover:border-gold hover:text-gold"><Play className="h-4 w-4" /> VİDEOYU İZLE</button>
              </div>
              <div className="mt-10 inline-flex items-center gap-2 rounded-md bg-navy-deep/70 px-4 py-2"><MapPin className="h-5 w-5 text-gold" /><span className="text-sm font-semibold">GAZİANTEP <span className="block text-[10px] text-muted-foreground">MERKEZ</span></span></div>
            </div>
