...
const CERTIFICATE_PACKAGES = [
  { id: "digital", name: "DİJİTAL", tier: "digital" as const, price: 199, img: "/digital-certificate.webp", features: ["Dijital sertifika", "Parsel kodu ve koordinatlar", "QR doğrulama", "E-posta ile anında teslim"] },
  { id: "elite", name: "ELİT", tier: "elite" as const, price: 499, img: "/elite-certificate.webp", features: ["Özel tasarım sertifika", "Dijital sertifika", "Parsel kodu ve koordinatlar", "QR doğrulama", "E-posta ile anında teslim"] },
  { id: "premium", name: "PREMİUM", tier: "premium" as const, price: 999, img: "/premium-certificate.webp", features: ["Özel tasarım sertifika", "Çerçeveli baskı (A4)", "Dijital sertifika", "Parsel kodu ve koordinatlar", "QR doğrulama"] },
] as const;
...
function CertificateImage({ src, alt, tier }: { src: string; alt: string; tier: "digital" | "elite" | "premium" }) {
  const [failed, setFailed] = useState(false);
  if (failed) return <CertificateArtwork tier={tier} />;
  return <img src={src} alt={alt} loading="lazy" width={1000} height={707} className="h-40 w-full rounded-lg object-contain" onError={() => setFailed(true)} />;
}
...
function Index() {
  ...
  return (
    <div className="starfield min-h-screen">
      <SiteHeader />
      <main>
        <section className="hero-sky-parcels relative min-h-[620px] overflow-hidden bg-cover bg-center bg-no-repeat lg:min-h-[700px]" style={{ backgroundImage: "url('/hero-background.png')" }}>
