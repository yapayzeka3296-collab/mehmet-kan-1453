...
function Landing() {
  return (
    <main className="relative z-0 min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="msp-ui-layer absolute left-4 top-4 sm:left-8 sm:top-8 lg:left-12 lg:top-10">
        <div className="pointer-events-auto flex flex-col items-start">
          ...
          <div className="mt-3 max-w-[260px] bg-transparent p-0 text-left">
            ...
            <p className="mt-1 text-[10px] font-medium text-foreground/85 sm:text-xs">Türkiye'den dünyaya açılacak bir proje.</p>
            <h1 className="mt-2 text-base font-bold leading-tight tracking-tight sm:text-xl">GÖKYÜZÜNDE KENDİ PARSELİNİ SEÇ.</h1>
            <p className="mt-1.5 text-[10px] leading-4 text-foreground/80 sm:text-xs sm:leading-5">Gökyüzündeki yerini keşfet.<br />Şehrini seç, parselini seç ve sana ait dijital gökyüzü parselini oluştur.</p>
          </div>
        </div>
      </div>
      <div className="msp-ui-layer absolute right-4 top-4 sm:right-8 sm:top-8 lg:right-12 lg:top-10">
