  ...
  head: () => ({
    meta: [
      { title: "MySkyParcel — Gökyüzünde Kendi Parselini Seç" },
      {
        name: "description",
        content:
          "81 il, 81 milyon parsel. Türkiye'den dünyaya açılan MySkyParcel projesini keşfet.",
      },
    ],
  }),
  component: Landing,
    ...
    <main className="relative z-0 min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="msp-ui-layer absolute left-4 top-4 z-20 sm:left-8 sm:top-8 lg:left-12 lg:top-10">
        <div className="pointer-events-auto flex flex-col items-start">
          <Logo />
          <div className="mt-3 max-w-[280px] bg-transparent p-0 text-left drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]">
            <p className="text-[9px] font-semibold tracking-[0.12em] text-cyan-100 sm:text-[10px]">
              81 İL · 81 MİLYON PARSEL
            </p>
            <p className="mt-1 text-[10px] font-medium text-foreground/90 sm:text-xs">
              Türkiye'den dünyaya açılacak bir proje.
            </p>
            <h1 className="mt-2 text-base font-bold leading-tight tracking-tight text-white sm:text-xl">
              GÖKYÜZÜNDE KENDİ PARSELİNİ SEÇ.
            </h1>
            <p className="mt-1.5 text-[10px] leading-4 text-foreground/85 sm:text-xs sm:leading-5">
