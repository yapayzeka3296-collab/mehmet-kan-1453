...
const FAQS = [
  ...
  { q: "Rezervasyon ile satın alma arasındaki fark nedir?", a: "Rezervasyon, satın alma sürecinde parselin geçici olarak ayrılmasıdır. Satın alma işlemi ve ödeme tamamlanmadan parselin kesin sahipliği oluşmuş kabul edilmez." },
