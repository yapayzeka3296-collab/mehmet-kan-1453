...
import { Activity, Award, Bell, Boxes, ClipboardList, FileText, LogOut, RefreshCw, Search, ShieldCheck, ShoppingCart, Users } from "lucide-react";
...
function Dashboard({ stats }: { stats: Stats | null }) {
  const [notifications, setNotifications] = useState<Row[]>([]); const [siteStats, setSiteStats] = useState<Stats | null>(null); const [siteStatsError, setSiteStatsError] = useState("");
