...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({ meta: [
    ...
    { rel: "icon", href: "/myskyparcel-icon.svg?v=2", type: "image/svg+xml" },
    { rel: "shortcut icon", href: "/myskyparcel-icon.svg?v=2", type: "image/svg+xml" },
    { rel: "apple-touch-icon", href: "/myskyparcel-icon.svg?v=2" },
  ] }),
