...
function RootShell({ children }: { children: ReactNode }) {
  return <html lang="tr" translate="no"><head><HeadContent /><meta name="google-site-verification" content="FnBKvdIxURn7yQQY7YNxhbM-sxPfNEjJf4GgmZKh0ec" /><script dangerouslySetInnerHTML={{ __html: `window.addEventListener('vite:preloadError', function () { if (!window.__myskyparcelChunkReload) { window.__myskyparcelChunkReload = '1'; window.location.reload(); } });` }} /></head><body>{children}<Scripts /></body></html>;
}
