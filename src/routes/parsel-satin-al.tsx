...
import { Check, FileBadge2, Loader2, LockKeyhole, Sparkles } from "lucide-react";
...
function SatinAl() {
  ...
  async function startPayment() {
    ...
    try {
      ...
      if (!token) { await navigate({ to: "/giris", search: { redirect: "/parsel-satin-al" } }); return; }
