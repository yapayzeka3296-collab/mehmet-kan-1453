...
-- This migration is additive: it does not delete existing tables or rows.
-- It separates public map data from private ownership data and adds the
-- deterministic city/layer/sector/parcel hierarchy required by the frontend.
