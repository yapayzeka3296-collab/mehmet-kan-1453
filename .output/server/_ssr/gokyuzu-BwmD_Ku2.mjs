...
import "./router-BOK32y4N.mjs";
import { _ as SphereGeometry, a as BufferGeometry, b as Vector2, c as LineLoop, d as Mesh, f as MeshBasicMaterial, g as Scene, h as SRGBColorSpace, l as MOUSE, m as Raycaster, n as WebGLRenderer, o as Group, p as PerspectiveCamera, s as LineBasicMaterial, t as MapControls, u as MathUtils, v as TOUCH, x as Vector3, y as TextureLoader } from "../_libs/three.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-BwmD_Ku2.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const worldCenterX = 8999 * TILE_SIZE / 2;
		const worldCenterZ = 8999 * TILE_SIZE / 2;
		camera.position.set(worldCenterX, 32, 45029);
		...
		const updateVisibleParcels = async () => {
			...
			const centerCityIndex = Math.floor(safeRow / CITY_GRID_SIZE) * CITY_BLOCKS + centerCityX;
		...
		const onPointerUp = (event) => {
			...
			const parcel = raycaster.intersectObjects(parcelLines.filter((line) => line.visible), false)[0]?.object?.userData?.parcel;
