...
import { n as Route$19, o as supabaseBrowser } from "./router-DmkJfQMv.mjs";
import { M as LoaderCircle, it as Check, j as LockKeyhole, q as FileBadge } from "../_libs/lucide-react.mjs";
import { n as SiteHeader, r as readParcelCart } from "./SiteHeader-HqrBEKCn.mjs";
import { t as SiteFooter } from "./SiteFooter-Dv3_EOXG.mjs";
import { n as TrustBar } from "./TrustBar-Ci8UbTsR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parsel-satin-al-Dm2IlQ47.mjs
...
function SatinAl() {
	...
	const { parcels, certificateParcel: requestedCertificate } = Route$19.useSearch();
	...
	async function startPayment() {
		...
		try {
			...
			const response = await fetch("/api/shopier/checkout", {
				...
				body: JSON.stringify({
					parcel_ids: items.map((item) => item.id),
			...
			if (!response.ok || !result.checkout_url) {
				setValidationError({
					shopier_not_configured: "Shopier ödeme bağlantısı henüz yapılandırılmamış.",
				...
				}[result.reason] ?? "Ödeme başlatılamadı. Lütfen tekrar deneyin.");
				return;
			}
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "flex min-w-0 flex-wrap items-center justify-between gap-4",
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												className: "min-w-0",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									disabled: !accepted || !physicalReady || paying,
									...
									children: [
										...
										" ",
										paying ? "ÖDEME HAZIRLANIYOR..." : "SHOPIER İLE GÜVENLİ ÖDEMEYE GEÇ"
									]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
