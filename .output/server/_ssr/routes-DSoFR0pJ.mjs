...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-DSoFR0pJ.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
var MySkyParcelEarthGlobe = (0, import_react.lazy)(() => import("./MySkyParcelEarthGlobe-oymCn3_7.mjs").then((module) => ({ default: module.MySkyParcelEarthGlobe })));
function Landing() {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Suspense, {
				fallback: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "absolute inset-0 bg-[#01040b]",
					"aria-label": "Küre yükleniyor"
				}),
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MySkyParcelEarthGlobe, { className: "h-screen rounded-none border-0 shadow-none" })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_75%_20%,rgba(34,211,238,0.08),transparent_32%),linear-gradient(180deg,rgba(1,4,11,0.12),rgba(1,4,11,0.3))]" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute left-4 top-4 z-40 sm:left-8 sm:top-8 lg:left-12 lg:top-10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-1 text-[10px] font-medium text-white/85 sm:text-xs",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-1.5 text-[10px] leading-4 text-white/80 sm:text-xs sm:leading-5",
								children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute right-4 top-4 z-40 sm:right-8 sm:top-8 lg:right-12 lg:top-10",
