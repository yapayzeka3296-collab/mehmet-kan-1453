...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-D-XdE3d3.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const onDragMove = (event) => {
			...
			lastPointerX = event.clientX;
			lastPointerY = event.clientY;
			const speed = Math.max(.16, controls.target.distanceTo(camera.position) * .012);
