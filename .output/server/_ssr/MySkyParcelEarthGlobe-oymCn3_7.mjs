...
//#region node_modules/.nitro/vite/services/ssr/assets/MySkyParcelEarthGlobe-oymCn3_7.mjs
...
function MySkyParcelEarthGlobe({ className = "" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: `relative h-[560px] w-full overflow-hidden rounded-3xl border border-sky-200/15 bg-[#01040b] shadow-2xl shadow-black/40 ${className}`,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			ref: mountRef,
			className: "absolute inset-0",
			"aria-label": "MySkyParcel görsel 3D Dünya küresi"
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "pointer-events-none absolute bottom-4 left-1/2 -translate-x-1/2 rounded-full border border-white/10 bg-black/35 px-3 py-1.5 text-[10px] text-white/60 backdrop-blur-md",
