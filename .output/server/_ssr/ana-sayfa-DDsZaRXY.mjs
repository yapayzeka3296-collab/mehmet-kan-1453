...
//#region node_modules/.nitro/vite/services/ssr/assets/ana-sayfa-DDsZaRXY.mjs
...
function Index() {
	...
	const [soldParcelCount, setSoldParcelCount] = (0, import_react.useState)(() => SOLD_PARCEL_BASE_COUNT + Math.max(0, Math.floor((Date.now() - SOLD_PARCEL_START_AT) / SOLD_PARCEL_HOUR_MS)) * 11);
