...
import { o as supabaseBrowser, t as Route$15 } from "./router-C6CnEoRm.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sertifika-dogrula-DPqp4Z0w.mjs
...
function Dogrula() {
	const { code: initialCode } = Route$15.useSearch();
