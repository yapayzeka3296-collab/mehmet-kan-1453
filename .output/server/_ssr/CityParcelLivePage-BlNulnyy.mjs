...
import { c as useAuth, s as supabaseBrowser } from "./router-DVbBeN20.mjs";
import { O as MapPin, V as Heart, ft as ArrowLeft, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
import { a as writeParcelCart, i as removeParcelFromCart, r as readParcelCart, t as PARCEL_CART_EVENT } from "./SiteHeader-BtNIKzjD.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CityParcelLivePage-BlNulnyy.js
...
function CityParcelLivePage({ slug }) {
	...
	const openMemory = (parcelId) => {
		window.location.href = `/parsel-hatirasi?parcel=${encodeURIComponent(parcelId)}`;
	};
	const buy = () => {
	...
	const legend = /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			TIER_ORDER.map((tier) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "h-3 w-3 fill-current" }), "Hatırası olan parseller"]
			})
		]
	});
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: Array.from({ length: VISIBLE_COUNT }, (_, i) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: `group relative z-[110] block h-full w-full min-h-0 min-w-0 select-none rounded-sm border ${sold ? "cursor-default" : "cursor-pointer"}`,
									style: {
									...
									children: [
										...
										hasMemory && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											type: "button",
											onClick: (event) => {
											...
											className: "absolute left-1/2 top-1/2 z-[145] -translate-x-1/2 -translate-y-1/2 rounded-full p-0.5 text-emerald-400 drop-shadow-[0_0_6px_rgba(34,197,94,.95)] transition-transform hover:scale-125 focus:outline-none focus:ring-1 focus:ring-emerald-300",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "h-3 w-3 fill-current sm:h-4 sm:w-4" })
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "pointer-events-none absolute left-1/2 top-1/2 z-[150] -translate-x-1/2 translate-y-[135%] whitespace-nowrap rounded-full border border-emerald-400/40 bg-slate-950/90 px-1.5 py-0.5 text-[6px] font-semibold text-emerald-300 opacity-0 shadow-lg transition-opacity group-hover:opacity-100 sm:text-[7px]",
