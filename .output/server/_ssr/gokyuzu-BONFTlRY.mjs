...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-BONFTlRY.mjs
	...
	(0, import_react.useEffect)(() => {
		...
		const updateVisibleParcels = () => {
			...
			for (let dz = -14; dz <= VISIBLE_Z; dz += 1) for (let dx = -18; dx <= VISIBLE_X; dx += 1) {
				...
				const points = [
					new Vector3(x, 0, z),
					new Vector3(x + TILE_SIZE, 0, z),
					new Vector3(x + TILE_SIZE, 0, z + TILE_SIZE),
					new Vector3(x, 0, z + TILE_SIZE)
				];
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "▦ Yeni parseller yüklenir" })
				]
			})
		]
	});
