...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-C8eg0BVZ.mjs
...
function Landing() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		className: "relative z-0 isolate min-h-screen overflow-hidden bg-background text-foreground",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_50%_45%,rgba(34,211,238,0.08),transparent_38%),linear-gradient(180deg,rgba(1,4,11,0.12),rgba(1,4,11,0.3))]" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative z-20 flex min-h-screen w-full flex-col items-center justify-center overflow-hidden px-4 py-20 sm:px-6 lg:px-8",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "pointer-events-auto relative z-30 flex w-full max-w-2xl flex-col items-center text-center",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Logo, {}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-3 max-w-[520px] drop-shadow-[0_2px_10px_rgba(0,0,0,0.55)]",
						children: [
					...
					className: "relative z-20 mt-2 flex h-[min(68vh,560px)] w-full min-w-0 max-w-[900px] items-center justify-center overflow-hidden sm:mt-4 lg:h-[min(72vh,640px)]",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MySkyParcelEarthGlobeSafe, { className: "relative z-20 h-full w-full min-w-0 max-w-full overflow-hidden rounded-none border-0 bg-transparent shadow-none" })
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "msp-ui-layer absolute right-4 top-4 z-40 sm:right-8 sm:top-8 lg:right-10 lg:top-8",
