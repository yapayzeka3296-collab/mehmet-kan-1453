...
import { c as supabaseBrowser, l as useAuth } from "./router-C8XNbiHi.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ParcelDetailPanel-_MTFGu7R.mjs
...
function ParcelDetailPanel({ parcel, onClose, onLocate }) {
	...
	const memoryPlaybackPromiseRef = (0, import_react.useRef)(null);
	...
	async function toggleMemoryPlayback() {
		...
		if (memoryPlaybackPromiseRef.current) return;
		const playPromise = audio.play();
		memoryPlaybackPromiseRef.current = playPromise;
		try {
			await playPromise;
		} catch (error) {
			...
			if (memoryPlaybackPromiseRef.current === playPromise) memoryPlaybackPromiseRef.current = null;
		}
	}
								...
								activeMusicUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-3.5 w-3.5" }), " OYNAT / DURDUR"]
										})]
										...
										preload: "auto",
										className: "w-full",
										onError: () => setMemoryMusicError("Müzik dosyası tarayıcı tarafından okunamadı. MP3 formatı ile tekrar deneyin."),
										children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", {
											src: activeMusicUrl,
											type: memoryMusicPreviewUrl && memoryMusicFile ? musicMimeType(memoryMusicFile) : musicMimeTypeFromPath(memory?.music_path)
										})
									})]
								}),
								...
								memoryMusicUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("audio", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", {
												src: memoryMusicUrl,
												type: musicMimeTypeFromPath(memory.music_path)
											})
										}),
										memoryMusicError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-3.5 w-3.5" }), " OYNAT"]
										})
									]
								}),
								memoryMessage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
