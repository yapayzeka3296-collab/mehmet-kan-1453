...
import { K as Globe, L as Layers, M as Lock, W as Headphones, f as Sparkles, g as ShieldCheck, lt as Boxes, ot as Check, pt as ArrowRight } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/ana-sayfa-NSYvET0Z.mjs
...
var SOLD_PARCEL_BASE_COUNT = 32960;
var SOLD_PARCEL_START_AT = (/* @__PURE__ */ new Date("2026-09-19T05:00:00+03:00")).getTime();
var SOLD_PARCEL_HOUR_MS = 36e5;
var POPULAR_CITIES = [
	{
		name: "İSTANBUL",
		slug: "istanbul",
...
function Index() {
	...
	const [soldParcelCount, setSoldParcelCount] = (0, import_react.useState)(() => SOLD_PARCEL_BASE_COUNT + Math.max(0, Math.floor((Date.now() - SOLD_PARCEL_START_AT) / SOLD_PARCEL_HOUR_MS)) * 10);
	const parcelModelCheck = SKY_PARCEL_MODEL.cityCount * SKY_PARCEL_MODEL.parcelsPerCity === SKY_PARCEL_MODEL.totalParcels;
	(0, import_react.useEffect)(() => {
		const updateSoldParcelCount = () => setSoldParcelCount(SOLD_PARCEL_BASE_COUNT + Math.max(0, Math.floor((Date.now() - SOLD_PARCEL_START_AT) / SOLD_PARCEL_HOUR_MS)) * 10);
		updateSoldParcelCount();
		const timer = window.setInterval(updateSoldParcelCount, 6e4);
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h1", {
									className: "break-words font-display text-3xl leading-[1.05] font-bold drop-shadow-lg sm:text-4xl lg:text-5xl",
									children: [
										"GÖKYÜZÜNDE",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: "/turkiye-haritasi",
									className: "btn-gold mt-3 inline-flex max-w-full items-center gap-2 rounded-md px-4 py-2 text-[10px] sm:px-5 sm:text-xs",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-4 w-4 shrink-0" }), " GÖKYÜZÜ HARİTASINA GİT"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "mt-4 rounded-xl border border-gold/50 bg-black/35 px-4 py-3 text-center shadow-xl backdrop-blur-sm",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-[9px] font-semibold tracking-[0.14em] text-gold sm:text-[10px]",
										children: "SATILAN PARSEL"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-1 font-display text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl",
										children: soldParcelCount.toLocaleString("tr-TR")
									})]
								})
							]
						})
