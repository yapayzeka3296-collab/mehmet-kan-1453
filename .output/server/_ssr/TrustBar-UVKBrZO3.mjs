...
//#region node_modules/.nitro/vite/services/ssr/assets/TrustBar-UVKBrZO3.mjs
var import_jsx_runtime = require_jsx_runtime();
var DEFAULT_TRUST = [
	{
		icon: ShieldCheck,
		title: "GÜVENLİ ÖDEME",
		text: "Ödeme, Shopier'in güvenli ödeme sayfasında tamamlanır."
	},
	{
		icon: Lock,
		title: "SSL / HTTPS",
...
var SECURITY_TRUST = [
	{
		icon: ShieldCheck,
		title: "GÜVENLİ ÖDEME",
		text: "Ödeme işlemi Shopier'in güvenli ödeme sayfasında gerçekleştirilir."
	},
	{
		icon: Lock,
		title: "GÜVENLİ ÖDEME",
		text: "Ödeme sağlayıcısının desteklediği güvenlik adımları kullanılır."
	},
	{
		icon: Award,
