...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-B_GkptlB.mjs
...
function Landing() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "pointer-events-none absolute inset-0 z-0 bg-[radial-gradient(circle_at_75%_20%,rgba(34,211,238,0.08),transparent_32%),linear-gradient(180deg,rgba(1,4,11,0.12),rgba(1,4,11,0.3))]" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "relative z-20 isolate flex h-[500px] w-full min-w-0 max-w-full items-center justify-center overflow-hidden lg:h-[600px] lg:w-1/2",
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MySkyParcelEarthGlobeSafe, { className: "relative z-20 h-full w-full max-w-full overflow-hidden rounded-none border-0 bg-transparent shadow-none" })
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
