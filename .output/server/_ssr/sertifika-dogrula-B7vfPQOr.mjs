...
import { o as supabaseBrowser, t as Route$16 } from "./router-DKyuhxkp.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sertifika-dogrula-B7vfPQOr.mjs
...
function Dogrula() {
	const { code: initialCode } = Route$16.useSearch();
