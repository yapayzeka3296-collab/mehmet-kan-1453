...
import { r as SiteHeader, t as Logo } from "./SiteHeader-DFBdppJD.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Ng_rPGZ5.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
var MySkyParcelEarthGlobeSafe = (0, import_react.lazy)(() => import("./MySkyParcelEarthGlobeSafe-BftY77hN.mjs").then((module) => ({ default: module.MySkyParcelEarthGlobeSafe })));
function Landing() {
