...
import { Y as Eye, _ as Share2, b as RefreshCw, h as ShieldCheck, n as X, ut as Award } from "../_libs/lucide-react.mjs";
import { n as SiteHeader } from "./SiteHeader-C82KMwTD.mjs";
import { t as SiteFooter } from "./SiteFooter-Dv3_EOXG.mjs";
import { n as TrustBar, t as SECURITY_TRUST } from "./TrustBar-UVKBrZO3.mjs";
import { t as UserSidebar } from "./UserSidebar-CtPKHPBe.mjs";
import { a as renderCertificateSvg, i as printCertificate, n as certificateTierLabel, o as templateTypeForTier, r as downloadSvg } from "./certificateTemplates-BmaaQXT4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sertifikalarim-EdoHBS52.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			selected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed inset-0 z-[2000] overflow-y-auto bg-black/80 p-3 sm:p-6",
				role: "dialog",
				"aria-modal": "true",
				"aria-label": "Sertifika önizleme",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mx-auto max-w-[576px] py-4 sm:py-8",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "fixed right-4 top-4 z-[2010] sm:right-6 sm:top-6",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CertificateRenderer, { certificate: selected })]
				})
			}),
