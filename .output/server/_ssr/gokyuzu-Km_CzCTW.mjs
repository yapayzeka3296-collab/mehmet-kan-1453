...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-Km_CzCTW.mjs
	...
	(0, import_react.useEffect)(() => {
		...
		const findParcelObject = (root) => {
			...
			while (object && object !== parcelGroup) {
				if (object.userData?.parcel || Number.isInteger(object.userData?.worldColumn) && Number.isInteger(object.userData?.worldRow)) return object;
