...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-yac_8Etk.mjs
	...
	(0, import_react.useEffect)(() => {
		...
		const start = async () => {
			...
			try {
				...
				renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, mobile === 1 ? .85 : 1));
				...
				const animate = (time = performance.now()) => {
					...
					const interval = interacting ? 1e3 / 60 : 1e3 / 30;
