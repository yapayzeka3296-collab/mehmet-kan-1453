...
import { b as Search, k as MapPin } from "../_libs/lucide-react.mjs";
import { n as SiteHeader } from "./SiteHeader-Bu3GwvvS.mjs";
import { t as CityParcelLivePage } from "./CityParcelLivePage-WS3aqS85.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/turkiye-haritasi-ElHK7iOt.mjs
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative flex min-h-[430px] items-center justify-center overflow-hidden bg-[#020914] px-1 py-2 sm:min-h-[560px] sm:p-5 lg:min-h-[min(70vh,650px)]",
