...
import { D as Menu, G as Globe, h as ShieldCheck, l as Store, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SiteHeader-Dx9hpDw1.mjs
...
function SiteHeader({ variant = "default" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex h-full min-w-0 max-w-7xl items-center gap-2 px-3 sm:gap-3 sm:px-5 lg:gap-3 lg:px-6 2xl:gap-4 2xl:px-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
