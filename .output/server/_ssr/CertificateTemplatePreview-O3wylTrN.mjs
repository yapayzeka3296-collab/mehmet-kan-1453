...
//#region node_modules/.nitro/vite/services/ssr/assets/CertificateTemplatePreview-O3wylTrN.mjs
...
function CertificateTemplatePreview({ tier, className = "" }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const loadPreview = async () => {
			try {
				const { renderCertificateSvg } = await import("./certificateTemplates-BoULmo9y.mjs").then((n) => n.t);
