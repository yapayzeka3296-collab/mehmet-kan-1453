...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-D7UtLkzm.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const updateHover = (event) => {
			...
			const next = raycaster.intersectObjects(realMeshes, false)[0]?.object ?? null;
