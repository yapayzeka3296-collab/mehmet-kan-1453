...
import { c as useAuth, s as supabaseBrowser } from "./router-C4W_cEKW.mjs";
import { O as MapPin, V as Heart, ft as ArrowLeft, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
import { a as writeParcelCart, i as removeParcelFromCart, r as readParcelCart, t as PARCEL_CART_EVENT } from "./SiteHeader-eOJI6sb7.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CityParcelLivePage-DXldtpTC.mjs
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: Array.from({ length: VISIBLE_COUNT }, (_, i) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: "relative z-[110] block h-full w-full min-h-0 min-w-0 cursor-pointer select-none rounded-sm border p-0 transition-all duration-200 hover:brightness-150 active:scale-95 focus:outline-none focus:ring-2 focus:ring-amber-200 disabled:cursor-not-allowed disabled:hover:brightness-100",
										...
										children: [
											...
											hasMemory && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: "pointer-events-none absolute -right-1.5 -top-1.5 z-[140] text-[10px] leading-none drop-shadow-[0_0_5px_rgba(255,166,90,.9)]",
												children: "🧡"
											}),
