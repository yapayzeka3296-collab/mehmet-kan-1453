...
import { n as Route$19, o as supabaseBrowser } from "./router-BxfBKsO2.mjs";
import { M as LoaderCircle, it as Check, j as LockKeyhole, q as FileBadge } from "../_libs/lucide-react.mjs";
import { n as SiteHeader, r as readParcelCart } from "./SiteHeader-CU6bbNhr.mjs";
import { t as SiteFooter } from "./SiteFooter-Dv3_EOXG.mjs";
import { n as TrustBar } from "./TrustBar-Ci8UbTsR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parsel-satin-al-BKoNfJ8d.mjs
	...
	async function startPayment() {
		...
		try {
			...
			if (!response.ok || !result.checkout_url) {
				...
				}[String(result.reason)] ?? "Ödeme başlatılamadı. Lütfen tekrar deneyin.");
				return;
			}
