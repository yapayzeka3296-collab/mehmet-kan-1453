...
import { n as Route$11, o as supabaseBrowser } from "./router-ByS23gnD.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sertifika-dogrula-ORTguslX.mjs
...
function Dogrula() {
	const { code: initialCode } = Route$11.useSearch();
