...
import { c as useAuth } from "./router-hJp5vZHr.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteHeader-LGZBIUCo.mjs
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					children: [visibleNavLinks.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						className: `relative shrink-0 whitespace-nowrap text-xs font-medium transition-colors 2xl:text-sm ${navText} ${navHover}`,
						children: item.label
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							title: "Pazar Yeri",
							className: `flex shrink-0 items-center gap-1.5 whitespace-nowrap p-2 text-xs font-medium ${navText} ${navHover}`,
						...
						isAuthenticated ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/panelim",
							className: `shrink-0 rounded-lg border px-3 py-2 text-sm font-medium 2xl:px-4 ${light ? "border-slate-300 text-slate-800" : "border-slate-700 text-slate-200"}`,
							children: "Panelim"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							"aria-label": "Pazar Yeri",
							title: "Pazar Yeri",
							className: `shrink-0 p-2 ${navText}`,
