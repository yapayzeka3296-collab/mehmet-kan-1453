...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzunu-tara-Wua19FY5.mjs
...
function smoothAngle(previous, next, factor = .18) {
	if (previous == null) return next;
	return (previous + ((next - previous + 540) % 360 - 180) * factor + 360) % 360;
}
function smoothValue(previous, next, factor = .18) {
...
function SkyScannerPage() {
	...
	const orientationSeenRef = (0, import_react.useRef)(false);
	...
	const startScanner = (0, import_react.useCallback)(async () => {
		...
		try {
			...
			if (typeof orientation.requestPermission === "function") {
				if (await orientation.requestPermission() !== "granted") throw new Error("Yön sensörü izni verilmedi. Gerçek konum tabanlı parseller için yön izni gereklidir.");
			}
			...
			children: [
				...
				cameraReady && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					...
					!sensorReady && sensor.location && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: orientationSeenRef.current ? "Telefonun yön/eğim sensörleri okunuyor. Telefonu yavaşça hareket ettirin ve kamerayı gökyüzüne doğrultun." : "Telefon yönü algılanıyor. Telefonu bir kez sağa-sola ve yukarı-aşağı yavaşça hareket ettirin."
					}),
