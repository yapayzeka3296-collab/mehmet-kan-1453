...
import { o as supabaseBrowser, s as useAuth } from "./router-BVJDeQHb.mjs";
import { E as PackageCheck, J as FileText, _ as ShieldAlert, a as UserRound, b as Search, dt as Ban, ft as Award, g as ShieldCheck, ht as Activity, it as CircleCheck, j as LogOut, l as Trash2, lt as Boxes, m as ShoppingCart, mt as ArrowLeft, nt as ClipboardList, o as UserPlus, r as Users, rt as CircleX, ut as Bell, x as RefreshCw } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/yonetim-Ba5bodPI.mjs
...
function AdminUserDetail({ userId, onBack }) {
	...
	if (error) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ArrowLeft, { className: "h-4 w-4" }), "Kullanıcılara dön"]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			role: "alert",
			className: "panel p-5 text-sm text-destructive",
			children: error
		})]
	});
	if (!user) return null;
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserRound, { className: "h-6 w-6 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-semibold",
						children: user.full_name || "Belirtilmemiş"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "mt-1",
							children: address || "Adres bilgisi bulunmuyor"
						})] }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-muted-foreground",
							children: "Rol"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							className: "mt-1",
							children: user.created_at ? new Date(user.created_at).toLocaleString("tr-TR") : "—"
						})] })
					]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
					className: "font-semibold",
					children: [
						"Satın Alınan Parseller (",
						parcels.length,
						")"
					]
				}), parcels.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					className: "mt-4 w-full min-w-[700px] text-left text-xs",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: parcels.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: p.price == null ? "—" : `${Number(p.price).toLocaleString("tr-TR")} ₺`
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: p.status
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: p.created_at ? new Date(p.created_at).toLocaleString("tr-TR") : "—"
							})
						]
					}, p.id)) })]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-muted-foreground",
					children: "Satın alınmış parsel yok."
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "panel overflow-auto p-5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h3", {
				...
				}), certificates.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
					className: "mt-4 w-full min-w-[800px] text-left text-xs",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
						className: "border-b border-border",
						children: [
							"Sertifika",
					...
					}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tbody", { children: certificates.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
						className: "border-b border-border/50",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: c.certificate_number || "—"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: c.parcel_number || "—"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: c.tier || "—"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
								className: "p-2",
								children: c.issued_at ? new Date(c.issued_at).toLocaleString("tr-TR") : "—"
							})
						]
					}, c.id)) })]
				}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-muted-foreground",
					children: "Sertifika yok."
				})]
			})
		]
	});
...
function AdminUserSearch({ initialRows }) {
	...
	const [actionUserId, setActionUserId] = (0, import_react.useState)(null);
	const [error, setError] = (0, import_react.useState)("");
	...
	if (selectedUserId) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AdminUserDetail, {
	...
	async function manageUser(userId, action) {
		...
		const { data, error: functionError } = await supabaseBrowser.functions.invoke("admin-user-management", { body: {
			action,
			user_id: userId
		} });
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							className: "inline-flex items-center justify-center gap-2 rounded-md border border-gold px-4 py-2 text-sm hover:bg-accent/40",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(UserPlus, { className: "h-4 w-4" }), showCreate ? "Kapat" : "Kullanıcı Ekle"]
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-xs text-muted-foreground",
					children: "Arama kullanıcı adı veya e-posta üzerinden veritabanında sunucu tarafında yapılır. Kullanıcı satırına dokunarak ayrıntıları açabilirsiniz."
				}),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								...
								onChange: (event) => setNewUser((value) => ({
									...value,
						...
						disabled: createLoading || !newUser.email || newUser.password.length < 10,
						onClick: () => void createUser(),
						className: "mt-3 rounded-md border border-gold px-4 py-2 text-sm hover:bg-accent/40 disabled:opacity-60",
						children: createLoading ? "Oluşturuluyor..." : "Kullanıcıyı Oluştur"
					})]
				}),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
					...
					tabIndex: 0,
					onKeyDown: (event) => {
						if (event.key === "Enter" || event.key === " ") setSelectedUserId(row.id);
					},
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
							children: row.is_active ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "inline-flex items-center gap-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-3.5 w-3.5" }), "Aktif"]
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								className: "inline-flex items-center gap-1",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Ban, { className: "h-3.5 w-3.5" }), "Pasif"]
							})
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									...
									onClick: () => void manageUser(row.id, row.is_active ? "disable" : "enable"),
									className: "rounded-md border border-border px-2 py-1 hover:border-gold disabled:opacity-60",
									children: row.is_active ? "Pasifleştir" : "Aktifleştir"
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									disabled: actionUserId === row.id,
									onClick: () => void manageUser(row.id, "delete"),
									title: "Üyeliği sil",
									"aria-label": "Üyeliği sil",
									className: "inline-flex items-center gap-1 rounded-md border border-border px-2 py-1 hover:border-destructive disabled:opacity-60",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: "h-3.5 w-3.5" }), "Sil"]
								})]
							})
						})
					]
	...
	async function load() {
		...
		if (module === "dashboard") {
			...
			const { data, error: rpcError } = await supabaseBrowser.rpc({
				...
				payments: "admin_list_payment_management",
...
function Dashboard({ stats, refreshKey }) {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { className: "h-5 w-5 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-semibold",
						children: "Teknik Site İstatistikleri"
					})]
					...
					children: "Teknik site istatistikleri yükleniyor..."
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "panel p-5 sm:col-span-2 xl:col-span-4",
...
function ModuleView({ module, rows, onReload }) {
	...
	if (module === "payments") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PaymentModule, { initialRows: rows });
...
function PaymentModule({ initialRows }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex items-center gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingCart, { className: "h-5 w-5 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					className: "font-semibold",
					children: "Ödeme Yönetimi"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-xs text-muted-foreground",
					children: "Tamamlanmış satın alma işlemleri gösterilir. Süresi dolmuş veya askıda kalan rezervasyonlar burada ödeme olarak görünmez."
				})] })]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-muted-foreground",
						children: "Tamamlanan ödeme"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 font-display text-2xl",
						children: rows.length.toLocaleString("tr-TR")
					})]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "rounded-md border border-border p-4",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs text-muted-foreground",
						children: "Gösterilen toplam"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-2 font-display text-2xl",
						children: [total.toLocaleString("tr-TR", {
			...
			className: "panel overflow-auto p-5",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				className: "w-full min-w-[1200px] text-left text-xs",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
					className: "border-b border-border",
					children: [
						"Alıcı",
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
							children: row.amount == null ? "—" : Number(row.amount).toLocaleString("tr-TR", {
								minimumFractionDigits: 2,
								maximumFractionDigits: 2
							})
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
							children: row.provider_reference || "—"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
							className: "p-2",
							children: row.purchased_at ? new Date(row.purchased_at).toLocaleString("tr-TR") : "—"
						})
					]
				}, row.order_id)) })]
			}), rows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "py-4 text-sm text-muted-foreground",
				children: "Tamamlanmış ödeme bulunmuyor."
			})]
		})]
	});
}
function AuditModule({ rows, onReload }) {
	...
	async function clearAudit() {
		if (!window.confirm("Audit günlüğündeki tüm kayıtları temizlemek istediğinizden emin misiniz?")) return;
		setError("");
		setClearing(true);
		const { error: rpcError } = await supabaseBrowser.rpc("admin_clear_all_audit_logs");
		if (rpcError) setError(rpcError.message);
		else await onReload();
		setClearing(false);
	}
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
					...
					className: "text-xs text-muted-foreground",
					children: "Yönetim işlemleri kayıtları."
				})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					disabled: clearing,
					onClick: () => void clearAudit(),
					className: "rounded-md border border-destructive/40 px-3 py-2 text-xs text-destructive hover:bg-destructive/10 disabled:opacity-60",
					children: clearing ? "Temizleniyor..." : "Audit Günlüğünü Temizle"
				})]
			}),
			error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				role: "alert",
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
				...
				children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					className: "p-2",
					children: row[column] == null ? "—" : String(row[column])
				}, column))
			}, row.id ?? index)) })]
		}), rows.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "py-4 text-sm text-muted-foreground",
