...
import { c as useAuth, s as supabaseBrowser } from "./router-D_dHW8hw.mjs";
import { O as MapPin, V as Heart, ft as ArrowLeft, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
import { a as writeParcelCart, i as removeParcelFromCart, r as readParcelCart, t as PARCEL_CART_EVENT } from "./SiteHeader-C-binbHp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CityParcelLivePage-VDmEhyqS.mjs
...
function CityParcelLivePage({ slug }) {
	...
	const [memoryNotice, setMemoryNotice] = (0, import_react.useState)(null);
		...
		async function load() {
			...
			try {
				...
				if (targetId) {
					...
					if (!targetMemoryError && targetMemory) {
						const targetRow = rows.find((p) => p.id === targetId);
						const number = targetNumber ?? targetRow?.parcel_number ?? targetId;
						if (alive) setMemoryNotice({
							parcelId: targetId,
							parcelNumber: number
						});
					}
	...
	const openMemory = (parcelId, parcelNumber) => {
		setMemoryNotice({
			parcelId,
			parcelNumber
		});
	...
	const goToMemory = () => {
		if (memoryNotice) window.location.href = `/parsel-hatirasi?parcel=${encodeURIComponent(memoryNotice.parcelId)}`;
	};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			memoryNotice && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed right-4 top-20 z-[260] w-[min(92vw,360px)] rounded-2xl border border-orange-300/30 bg-[#071a2d]/95 p-4 shadow-2xl shadow-black/50 backdrop-blur-md",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-start gap-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "grid h-9 w-9 shrink-0 place-items-center rounded-full bg-orange-300/10",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, { className: "h-4 w-4 text-orange-200" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "min-w-0 flex-1",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-xs font-bold text-orange-100",
									children: "Bu parselde bir hatıra var"
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "mt-1 text-[11px] text-white/55",
									children: [memoryNotice.parcelNumber, " parselindeki hatırayı görmek ister misin?"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: goToMemory,
										className: "rounded-lg bg-orange-300 px-3 py-2 text-[10px] font-extrabold text-slate-950",
										children: "HATIRAYI GÖR"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										onClick: () => setMemoryNotice(null),
										className: "rounded-lg border border-white/10 px-3 py-2 text-[10px] font-semibold text-white/65",
										children: "KAPAT"
									})]
								})
							]
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setMemoryNotice(null),
							"aria-label": "Hatıra bildirimini kapat",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								...
								children: Array.from({ length: VISIBLE_COUNT }, (_, i) => {
									...
									return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
										...
										className: "group relative z-[110] block h-full w-full min-h-0 min-w-0 cursor-pointer select-none rounded-sm border p-0 transition-all duration-200 hover:brightness-150 active:scale-95 focus:outline-none focus:ring-2 focus:ring-amber-200 disabled:cursor-not-allowed disabled:hover:brightness-100",
										...
										children: [
											...
											hasMemory && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
												className: "absolute right-1 top-1 z-[160] flex h-5 w-5 items-center justify-center rounded-full bg-emerald-400/10 text-emerald-400 drop-shadow-[0_0_6px_rgba(52,211,153,.95)] cursor-pointer",
												role: "button",
												tabIndex: 0,
												...
												onClick: (event) => {
													event.preventDefault();
													event.stopPropagation();
													openMemory(p.id, p.parcel_number);
												},
												onKeyDown: (event) => {
												...
												children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, {
													...
													className: "pointer-events-none absolute right-0 top-[-20px] whitespace-nowrap rounded-md border border-emerald-300/20 bg-[#071a2d]/95 px-1.5 py-0.5 text-[8px] font-semibold text-emerald-200 opacity-0 shadow-lg transition-opacity duration-150 group-hover:opacity-100",
