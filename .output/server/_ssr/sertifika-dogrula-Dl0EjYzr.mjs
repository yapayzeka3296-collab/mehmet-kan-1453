...
import { o as supabaseBrowser, t as Route$14 } from "./router-KoNLNp6X.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sertifika-dogrula-Dl0EjYzr.mjs
...
function Dogrula() {
	const { code: initialCode } = Route$14.useSearch();
