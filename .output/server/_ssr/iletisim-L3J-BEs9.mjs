...
//#region node_modules/.nitro/vite/services/ssr/assets/iletisim-L3J-BEs9.mjs
...
function Iletisim() {
	...
	async function handleSubmit(e) {
		...
		setStatusText("");
		try {
			const { supabaseBrowser } = await import("./supabaseBrowser-efymGaNG.mjs").then((n) => n.r).then((n) => n.r);
