...
import { c as supabaseBrowser, l as useAuth } from "./router-Dv81ICwX.mjs";
import { E as Music2, O as MapPin, S as Play, c as Trash2, n as X, p as ShoppingCart, w as Pencil, z as ImagePlus } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ParcelDetailPanel-Dv7hIPta.mjs
...
var musicMimeTypeFromPath = (path) => {
	return {
		mp3: "audio/mpeg",
		m4a: "audio/mp4",
		aac: "audio/aac",
		...
		ogg: "audio/ogg",
		webm: "audio/webm"
	}[(path?.split("?")[0].split(".").pop() || "").toLowerCase()] ?? "audio/mpeg";
};
function ParcelDetailPanel({ parcel, onClose, onLocate }) {
	...
	(0, import_react.useEffect)(() => {
		...
		if (memoryAudioRef.current) {
			...
			memoryAudioRef.current.removeAttribute("src");
	...
	function cancelMemoryEditor() {
		if (memoryAudioRef.current) memoryAudioRef.current.pause();
		setMemoryMusicPlaying(false);
		setMemoryMessage(null);
		setMemoryMusicError(null);
		setMemoryFile(null);
	...
	function handleMemoryMusicChange(event) {
		...
		const contentType = musicMimeType(file);
		...
		if (!document.createElement("audio").canPlayType(contentType)) setMemoryMusicError("Bu ses formatı tarayıcıda doğrudan oynatılamıyor. MP3 kullanmanız önerilir.");
	...
	async function handleMemorySave() {
		...
		try {
			...
			if (memoryMusicFile) {
				...
				if (!document.createElement("audio").canPlayType(contentType)) throw new Error("Bu ses formatı tarayıcıda oynatılamıyor. MP3 kullanmanızı öneririm.");
	...
	async function toggleMemoryPlayback() {
		const audio = memoryAudioRef.current;
		if (!audio || !activeMusicUrl) {
			setMemoryMusicError("Oynatılacak bir müzik bulunamadı.");
			return;
		}
		setMemoryMusicError(null);
		if (!audio.paused) {
	...
	const renderMemoryAudio = (url, type) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("audio", {
		ref: memoryAudioRef,
		src: url,
		controls: true,
		preload: "metadata",
		...
		onError: () => {
			setMemoryMusicPlaying(false);
			setMemoryMusicError("Müzik dosyası tarayıcı tarafından okunamadı. MP3 formatı ile tekrar deneyin.");
		},
		"aria-label": "Parsel hatırası müziği",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("track", { kind: "captions" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Tarayıcınız ses oynatmayı desteklemiyor." })]
	}, url);
								...
								activeMusicUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											"aria-label": memoryMusicPlaying ? "Müziği duraklat" : "Müziği oynat",
											children: [
												/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Play, { className: "h-3.5 w-3.5" }),
												" ",
												memoryMusicPlaying ? "DURAKLAT" : "OYNAT"
											]
										})]
									}), renderMemoryAudio(activeMusicUrl, memoryMusicPreviewUrl && memoryMusicFile ? musicMimeType(memoryMusicFile) : musicMimeTypeFromPath(memory?.music_path))]
								}),
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: memoryMusicPlaying ? "Çalıyor" : "Hazır"
											})]
										}),
										renderMemoryAudio(memoryMusicUrl, musicMimeTypeFromPath(memory.music_path)),
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
											type: "button",
											onClick: () => void toggleMemoryPlayback(),
