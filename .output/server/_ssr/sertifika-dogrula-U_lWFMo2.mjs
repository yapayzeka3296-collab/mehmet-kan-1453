...
import { o as supabaseBrowser, t as Route$12 } from "./router-brjTKa-f.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/sertifika-dogrula-U_lWFMo2.mjs
...
function Dogrula() {
	const { code: initialCode } = Route$12.useSearch();
