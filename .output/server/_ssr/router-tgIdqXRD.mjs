...
import { C as useRouter, S as useSearch, _ as createRootRouteWithContext, d as useRouterState, g as createFileRoute, h as lazyRouteComponent, l as Scripts, m as Outlet, p as createRouter, u as HeadContent, v as Link, y as require_react_dom } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as QueryClient } from "../_libs/tanstack__query-core.mjs";
import { n as objectType, r as stringType, t as arrayType } from "../_libs/zod.mjs";
import { createHmac, timingSafeEqual } from "node:crypto";
//#region node_modules/.nitro/vite/services/ssr/assets/supabaseBrowser-BU58SfZL.mjs
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-tgIdqXRD.mjs
var router_tgIdqXRD_exports = /* @__PURE__ */ __exportAll({
	a: () => useAuth,
	getRouter: () => getRouter,
	i: () => Route$22,
	n: () => Route$4,
...
function SiteVisitTracker() {
	...
	(0, import_react.useEffect)(() => {
		...
		record();
		const retryTimer = window.setTimeout(() => void record(), 2e3);
		const interval = window.setInterval(() => void record(), 6e4);
		return () => {
			disposed = true;
	...
	(0, import_react.useEffect)(() => {
		...
		loadStats();
		const timer = window.setInterval(() => void loadStats(), 1e4);
		return () => {
			cancelled = true;
			observer.disconnect();
...
var Route$51 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Kişiye özel hediye ve dijital hediye arayanlar için MySkyParcel: gökyüzünde sembolik parsel seçimi, kişiye özel dijital sertifika ve unutulmaz bir sürpriz."
			},
			{
				name: "author",
				content: "MySkyParcel"
			...
			{
				property: "og:title",
				content: "MySkyParcel — Kişiye Özel Dijital Hediye ve Gökyüzü Parseli"
			},
			{
				property: "og:description",
				content: "Sevgiliye özel, farklı ve anlamlı bir dijital hediye: kişiye özel gökyüzü parseli ve sertifika."
			},
			{
				property: "og:type",
				content: "website"
			...
			{
				property: "og:url",
				content: "https://myskyparcel.com/"
			},
			{
				property: "og:image",
				content: "https://myskyparcel.com/hero-background.jpg"
			},
			{
			...
			},
			{
				...
				content: "MySkyParcel gökyüzü parselleri"
			},
			{
				name: "twitter:card",
		...
		scripts: [
			{
				async: true,
				src: "https://www.googletagmanager.com/gtag/js?id=G-FC8Y1KFEE1"
			},
			{ children: "window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-FC8Y1KFEE1');" },
			{
				...
				children: JSON.stringify({
					...
					"@graph": [{
						"@type": "WebSite",
						"@id": "https://myskyparcel.com/#website",
						"url": "https://myskyparcel.com/",
						"name": "MySkyParcel",
						"description": "Kişiye özel dijital hediye, sembolik gökyüzü parseli ve dijital sertifika platformu.",
						"inLanguage": "tr-TR"
					}, {
						"@type": "Organization",
						"@id": "https://myskyparcel.com/#organization",
						"name": "MySkyParcel",
						"url": "https://myskyparcel.com/"
					}]
				})
...
var $$splitComponentImporter$40 = () => import("./routes-DYMS3-eH.mjs");
...
var Route$49 = createFileRoute("/admin-check")({ server: { handlers: { GET } } });
var $$splitComponentImporter$39 = () => import("./ana-sayfa-DNhBq9yJ.mjs");
var Route$48 = createFileRoute("/ana-sayfa")({
	head: () => ({
		meta: [{ title: "MySkyParcel — Kişiye Özel Hediye, Dijital Hediye ve Gökyüzü Parseli" }, {
			name: "description",
			content: "Kişiye özel hediye, sevgiliye farklı hediye ve dijital hediye arayanlar için MySkyParcel: gökyüzünde sembolik parsel ve kişiye özel dijital sertifika."
		}],
		links: [{
			rel: "canonical",
			href: "https://myskyparcel.com/ana-sayfa"
		}]
	}),
	component: lazyRouteComponent($$splitComponentImporter$39, "component")
});
var $$splitComponentImporter$38 = () => import("./bildirimler-BKRP3QwG.mjs");
var Route$47 = createFileRoute("/bildirimler")({ component: lazyRouteComponent($$splitComponentImporter$38, "component") });
var $$splitComponentImporter$37 = () => import("./cerez-politikasi-Dq_J6WUH.mjs");
var Route$46 = createFileRoute("/cerez-politikasi")({
...
var $$splitComponentImporter$36 = () => import("./destek-DDGZ08Mj.mjs");
var Route$45 = createFileRoute("/destek")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$35 = () => import("./dogrula-BjgdSF6C.mjs");
var Route$44 = createFileRoute("/dogrula")({
...
var $$splitComponentImporter$34 = () => import("./dogum-gunu-hediyesi-C-fCg62O.mjs");
var Route$43 = createFileRoute("/dogum-gunu-hediyesi")({
	head: () => ({
		meta: [
			{ title: "Doğum Günü Hediyesi ve Farklı Hediye Fikirleri — MySkyParcel" },
			{
				name: "description",
				content: "Doğum günü hediyesi, sevgiliye doğum günü hediyesi ve farklı hediye fikirleri arayanlar için kişiye özel dijital gökyüzü parseli fikrini keşfedin."
			},
			{
				property: "og:title",
				content: "Doğum Günü Hediyesi — MySkyParcel"
			},
			{
				property: "og:description",
				content: "Farklı, ilginç ve kişiye özel bir doğum günü hediyesi fikri."
			}
		],
		links: [{
			rel: "canonical",
			href: "https://myskyparcel.com/dogum-gunu-hediyesi"
		}]
	}),
	component: lazyRouteComponent($$splitComponentImporter$34, "component")
});
var $$splitComponentImporter$33 = () => import("./giris-BqUSAQKm.mjs");
var Route$42 = createFileRoute("/giris")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$32 = () => import("./gizlilik-politikasi-OCCQT4_L.mjs");
var Route$41 = createFileRoute("/gizlilik-politikasi")({
	head: () => ({ meta: [{ title: "Gizlilik Politikası — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$32, "component")
});
var $$splitComponentImporter$31 = () => import("./gokyuzu-ChOV6oYJ.mjs");
var Route$40 = createFileRoute("/gokyuzu")({ component: lazyRouteComponent($$splitComponentImporter$31, "component") });
var $$splitComponentImporter$30 = () => import("./gokyuzu-haritasi-CWc4OWzC.mjs");
var Route$39 = createFileRoute("/gokyuzu-haritasi")({ component: lazyRouteComponent($$splitComponentImporter$30, "component") });
var $$splitComponentImporter$29 = () => import("./guvenlik-ayarlari-Dt9_oV6x.mjs");
...
var $$splitComponentImporter$28 = () => import("./hakkimizda-DVEBOWw1.mjs");
var Route$37 = createFileRoute("/hakkimizda")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$27 = () => import("./hediye-kabul-BowuHtlS.mjs");
var Route$36 = createFileRoute("/hediye-kabul")({
...
var $$splitComponentImporter$26 = () => import("./hediyelerim-D-ZDTWhO.mjs");
var Route$35 = createFileRoute("/hediyelerim")({
...
var $$splitComponentImporter$25 = () => import("./iade-iptal-politikasi-BBhviE0k.mjs");
var Route$34 = createFileRoute("/iade-iptal-politikasi")({
...
var $$splitComponentImporter$24 = () => import("./iletisim-D50y09Cg.mjs");
var Route$33 = createFileRoute("/iletisim")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$23 = () => import("./kayit-ol-BRWPgDoT.mjs");
var Route$32 = createFileRoute("/kayit-ol")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$22 = () => import("./kisiye-ozel-hediye-DFbdiHQM.mjs");
var Route$31 = createFileRoute("/kisiye-ozel-hediye")({
	head: () => ({
		meta: [
			{ title: "Kişiye Özel Hediye ve Dijital Hediye Fikirleri — MySkyParcel" },
			{
				name: "description",
				content: "Kişiye özel hediye, kişiye özel dijital hediye ve anlamlı dijital hediye arayanlar için MySkyParcel gökyüzü parseli deneyimini keşfedin."
			},
			{
				property: "og:title",
				content: "Kişiye Özel Hediye — MySkyParcel"
			},
			{
				property: "og:description",
				content: "Kişiselleştirilebilir, dijital ve anlamlı bir hediye fikri."
			}
		],
		links: [{
			rel: "canonical",
			href: "https://myskyparcel.com/kisiye-ozel-hediye"
		}]
	}),
	component: lazyRouteComponent($$splitComponentImporter$22, "component")
});
var $$splitComponentImporter$21 = () => import("./kullanim-sartlari-mmjK5922.mjs");
var Route$30 = createFileRoute("/kullanim-sartlari")({
	head: () => ({ meta: [{ title: "Kullanım Şartları — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$21, "component")
});
var $$splitComponentImporter$20 = () => import("./kvkk-LGF4RPX-.mjs");
var Route$29 = createFileRoute("/kvkk")({
...
var $$splitComponentImporter$19 = () => import("./mesafeli-satis-sozlesmesi-D4rk2O-l.mjs");
var Route$28 = createFileRoute("/mesafeli-satis-sozlesmesi")({
...
var $$splitComponentImporter$18 = () => import("./nasil-calisir-BVLrXX0m.mjs");
var Route$27 = createFileRoute("/nasil-calisir")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$17 = () => import("./on-bilgilendirme-formu-CLtWrQK7.mjs");
var Route$26 = createFileRoute("/on-bilgilendirme-formu")({
...
var $$splitComponentImporter$16 = () => import("./paketler-OObVzchK.mjs");
var Route$25 = createFileRoute("/paketler")({
	head: () => ({ meta: [{ title: "Kişiye Özel Dijital Hediye ve Sertifika Paketleri — MySkyParcel" }, {
		name: "description",
		content: "Kişiye özel hediye, sevgiliye özel hediye, farklı ve anlamlı dijital hediye arayanlar için MySkyParcel sertifika paketlerini inceleyin."
	}] }),
	component: lazyRouteComponent($$splitComponentImporter$16, "component")
});
var $$splitComponentImporter$15 = () => import("./panelim-DQ038NGq.mjs");
var Route$24 = createFileRoute("/panelim")({
...
var Route$23 = createFileRoute("/parsel-hatirasi")({ component: ParcelHatirasiPage });
...
var $$splitComponentImporter$14 = () => import("./parsel-satin-al-Bkuaiay_.mjs");
var Route$22 = createFileRoute("/parsel-satin-al")({
...
var $$splitComponentImporter$13 = () => import("./parsellerim-BEQ4DIJg.mjs");
var Route$21 = createFileRoute("/parsellerim")({
...
var $$splitComponentImporter$12 = () => import("./pazar-yeri-X8xNtASB.mjs");
var Route$20 = createFileRoute("/pazar-yeri")({
...
var $$splitComponentImporter$11 = () => import("./profilim-COXtZB7X.mjs");
var Route$19 = createFileRoute("/profilim")({
	head: () => ({ meta: [
...
var Route$18 = createFileRoute("/purchase")({ server: { handlers: { POST: POST$1 } } });
...
var Route$17 = createFileRoute("/purchase-bulk")({ server: { handlers: { POST } } });
var $$splitComponentImporter$10 = () => import("./sertifika-dogrula-BrfndSd6.mjs");
var Route$16 = createFileRoute("/sertifika-dogrula")({
...
var $$splitComponentImporter$9 = () => import("./sertifika-talep-Dq6QhKeH.mjs");
var Route$15 = createFileRoute("/sertifika-talep")({
	head: () => ({ meta: [{ title: "Sertifika Oluştur — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
var $$splitComponentImporter$8 = () => import("./sertifikalarim-DEXDC6dk.mjs");
var Route$14 = createFileRoute("/sertifikalarim")({
...
var $$splitComponentImporter$7 = () => import("./sevgiliye-hediye-C_89qaku.mjs");
var Route$13 = createFileRoute("/sevgiliye-hediye")({
	head: () => ({
		meta: [
			{ title: "Sevgiliye Özel Hediye ve Farklı Sürpriz Fikirleri — MySkyParcel" },
			{
				name: "description",
				content: "Sevgiliye özel, farklı, ilginç ve sürpriz bir hediye arayanlar için kişiye özel dijital gökyüzü parseli ve sertifika fikrini keşfedin."
			},
			{
				property: "og:title",
				content: "Sevgiliye Özel Hediye — MySkyParcel"
			},
			{
				property: "og:description",
				content: "Sevgiliye farklı, anlamlı ve kişiye özel bir dijital hediye fikri."
			}
		],
		links: [{
			rel: "canonical",
			href: "https://myskyparcel.com/sevgiliye-hediye"
		}]
	}),
	component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
var $$splitComponentImporter$6 = () => import("./sifre-yenile-C27vJDXF.mjs");
var Route$12 = createFileRoute("/sifre-yenile")({
...
var $$splitComponentImporter$5 = () => import("./sifremi-unuttum-1tlRbPTH.mjs");
var Route$11 = createFileRoute("/sifremi-unuttum")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$4 = () => import("./siparislerim-CYAXK07I.mjs");
var Route$10 = createFileRoute("/siparislerim")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$3 = () => import("./turkiye-haritasi-BYdCIYqW.mjs");
var Route$9 = createFileRoute("/turkiye-haritasi")({
	head: () => ({ links: [{
		rel: "preload",
...
var $$splitComponentImporter$2 = () => import("./uyelik-sozlesmesi-DSXlX8n8.mjs");
var Route$8 = createFileRoute("/uyelik-sozlesmesi")({
...
var $$splitComponentImporter$1 = () => import("./yonetim-CjXGEt05.mjs");
var Route$7 = createFileRoute("/yonetim")({
...
var Route$6 = createFileRoute("/api/earth-assets")({ server: { handlers: { GET: async ({ request }) => {
...
*/
var Route$5 = createFileRoute("/api/shopier-checkout-intent")({ server: { handlers: { POST: async ({ request }) => {
...
var $$splitComponentImporter = () => import("../_slug-B892PY6s.mjs");
...
*/
var deleteShopierProduct = async (productId, shopierPat) => {
...
var cleanupStaleShopierProducts = async (serviceSupabase, shopierPat) => {
	const { data, error } = await serviceSupabase.from("shopier_checkout_intents").select("id,shopier_product_id,status,shopier_payment_id").in("status", ["expired", "failed"]).not("shopier_product_id", "is", null).is("shopier_payment_id", null).limit(100);
	if (error) {
		console.error("Stale Shopier product lookup failed", {
			code: error.code,
			message: error.message
		});
		return;
	}
	const staleIntents = data ?? [];
	for (const row of staleIntents) {
		const productId = getString(row.shopier_product_id);
		if (!productId) continue;
		if (await deleteShopierProduct(productId, shopierPat)) console.info("Stale Shopier product removed", {
...
var Route$3 = createFileRoute("/api/shopier/checkout")({ server: { handlers: { POST: async ({ request }) => {
	...
	try {
		...
		const cleanupExpiredState = async () => {
			...
			if (cleanupError) {
				console.error("Shopier expired-state cleanup failed", {
		...
		if (!shopierResponse.ok) {
			const apiMessage = (getString(shopierBody.message) || getString(shopierBody.error) || getString(shopierBody.detail)).slice(0, SHOPIER_ERROR_LIMIT);
			const diagnostic = {
		...
		const checkoutUrl = [
			...
			productUrl,
			canonicalProductUrl
		].find((candidate) => candidate && isShopierUrl$1(candidate)) || canonicalProductUrl;
...
<body>
  ...
  <form id="shopier-checkout" method="POST" action="https://www.shopier.com/s/shipping/${escapeHtml(encodeURIComponent(shopSlug))}">
...
var rootRouteChildren = {
	IndexRoute: Route$50.update({
		id: "/",
		path: "/",
		getParentRoute: () => Route$51
	}),
	AdminCheckRoute: Route$49.update({
		id: "/admin-check",
		path: "/admin-check",
		getParentRoute: () => Route$51
	}),
	AnaSayfaRoute: Route$48.update({
		id: "/ana-sayfa",
		path: "/ana-sayfa",
		getParentRoute: () => Route$51
	}),
	BildirimlerRoute: Route$47.update({
		id: "/bildirimler",
		path: "/bildirimler",
		getParentRoute: () => Route$51
	}),
	CerezPolitikasiRoute: Route$46.update({
		id: "/cerez-politikasi",
		path: "/cerez-politikasi",
		getParentRoute: () => Route$51
	}),
	DestekRoute: Route$45.update({
		id: "/destek",
		path: "/destek",
		getParentRoute: () => Route$51
	}),
	DogrulaRoute: Route$44.update({
		id: "/dogrula",
		path: "/dogrula",
		getParentRoute: () => Route$51
	}),
	DogumGunuHediyesiRoute: Route$43.update({
		id: "/dogum-gunu-hediyesi",
		path: "/dogum-gunu-hediyesi",
		getParentRoute: () => Route$51
	}),
	GirisRoute: Route$42.update({
		id: "/giris",
		path: "/giris",
		getParentRoute: () => Route$51
	}),
	GizlilikPolitikasiRoute: Route$41.update({
		id: "/gizlilik-politikasi",
		path: "/gizlilik-politikasi",
		getParentRoute: () => Route$51
	}),
	GokyuzuRoute: Route$40.update({
		id: "/gokyuzu",
		path: "/gokyuzu",
		getParentRoute: () => Route$51
	}),
	GokyuzuHaritasiRoute: Route$39.update({
		id: "/gokyuzu-haritasi",
	...
	HakkimizdaRoute: Route$37.update({
		id: "/hakkimizda",
		path: "/hakkimizda",
		getParentRoute: () => Route$51
	}),
	HediyeKabulRoute: Route$36.update({
		id: "/hediye-kabul",
		path: "/hediye-kabul",
		getParentRoute: () => Route$51
	}),
	HediyelerimRoute: Route$35.update({
		id: "/hediyelerim",
		path: "/hediyelerim",
		getParentRoute: () => Route$51
	}),
	IadeIptalPolitikasiRoute: Route$34.update({
		id: "/iade-iptal-politikasi",
		path: "/iade-iptal-politikasi",
		getParentRoute: () => Route$51
	}),
	IletisimRoute: Route$33.update({
		id: "/iletisim",
		path: "/iletisim",
		getParentRoute: () => Route$51
	}),
	KayitOlRoute: Route$32.update({
		id: "/kayit-ol",
		path: "/kayit-ol",
		getParentRoute: () => Route$51
	}),
	KisiyeOzelHediyeRoute: Route$31.update({
		id: "/kisiye-ozel-hediye",
		path: "/kisiye-ozel-hediye",
		getParentRoute: () => Route$51
	}),
	KullanimSartlariRoute: Route$30.update({
		id: "/kullanim-sartlari",
		path: "/kullanim-sartlari",
		getParentRoute: () => Route$51
	}),
	KvkkRoute: Route$29.update({
		id: "/kvkk",
		path: "/kvkk",
		getParentRoute: () => Route$51
	}),
	MesafeliSatisSozlesmesiRoute: Route$28.update({
		id: "/mesafeli-satis-sozlesmesi",
		path: "/mesafeli-satis-sozlesmesi",
		getParentRoute: () => Route$51
	}),
	NasilCalisirRoute: Route$27.update({
		id: "/nasil-calisir",
		path: "/nasil-calisir",
		getParentRoute: () => Route$51
	}),
	OnBilgilendirmeFormuRoute: Route$26.update({
		id: "/on-bilgilendirme-formu",
		path: "/on-bilgilendirme-formu",
		getParentRoute: () => Route$51
	}),
	PaketlerRoute: Route$25.update({
		id: "/paketler",
		path: "/paketler",
		getParentRoute: () => Route$51
	}),
	PanelimRoute: Route$24.update({
		id: "/panelim",
		path: "/panelim",
		getParentRoute: () => Route$51
	}),
	ParselHatirasiRoute: Route$23.update({
		id: "/parsel-hatirasi",
		path: "/parsel-hatirasi",
		getParentRoute: () => Route$51
	}),
	ParselSatinAlRoute: Route$22.update({
		id: "/parsel-satin-al",
		path: "/parsel-satin-al",
		getParentRoute: () => Route$51
	}),
	ParsellerimRoute: Route$21.update({
		id: "/parsellerim",
		path: "/parsellerim",
		getParentRoute: () => Route$51
	}),
	PazarYeriRoute: Route$20.update({
		id: "/pazar-yeri",
		path: "/pazar-yeri",
		getParentRoute: () => Route$51
	}),
	ProfilimRoute: Route$19.update({
		id: "/profilim",
		path: "/profilim",
		getParentRoute: () => Route$51
	}),
	PurchaseRoute: Route$18.update({
		id: "/purchase",
		path: "/purchase",
		getParentRoute: () => Route$51
	}),
	PurchaseBulkRoute: Route$17.update({
		id: "/purchase-bulk",
		path: "/purchase-bulk",
		getParentRoute: () => Route$51
	}),
	SertifikaDogrulaRoute: Route$16.update({
		id: "/sertifika-dogrula",
		path: "/sertifika-dogrula",
		getParentRoute: () => Route$51
	}),
	SertifikaTalepRoute: Route$15.update({
		id: "/sertifika-talep",
		path: "/sertifika-talep",
		getParentRoute: () => Route$51
	}),
	SertifikalarimRoute: Route$14.update({
		id: "/sertifikalarim",
		path: "/sertifikalarim",
		getParentRoute: () => Route$51
	}),
	SevgiliyeHediyeRoute: Route$13.update({
		id: "/sevgiliye-hediye",
		path: "/sevgiliye-hediye",
		getParentRoute: () => Route$51
	}),
	SifreYenileRoute: Route$12.update({
		id: "/sifre-yenile",
		path: "/sifre-yenile",
		getParentRoute: () => Route$51
	}),
	SifremiUnuttumRoute: Route$11.update({
		id: "/sifremi-unuttum",
		path: "/sifremi-unuttum",
		getParentRoute: () => Route$51
	}),
	SiparislerimRoute: Route$10.update({
		id: "/siparislerim",
		path: "/siparislerim",
		getParentRoute: () => Route$51
	}),
	TurkiyeHaritasiRoute: Route$9.update({
		id: "/turkiye-haritasi",
		path: "/turkiye-haritasi",
		getParentRoute: () => Route$51
	}),
	UyelikSozlesmesiRoute: Route$8.update({
		id: "/uyelik-sozlesmesi",
		path: "/uyelik-sozlesmesi",
		getParentRoute: () => Route$51
	}),
	YonetimRoute: Route$7.update({
		id: "/yonetim",
		path: "/yonetim",
		getParentRoute: () => Route$51
	}),
	ApiEarthAssetsRoute: Route$6.update({
		id: "/api/earth-assets",
		path: "/api/earth-assets",
		getParentRoute: () => Route$51
	}),
	ApiShopierCheckoutIntentRoute: Route$5.update({
...
//#endregion
export { useAuth as a, router_tgIdqXRD_exports as i, Route$22 as n, createBrowserSupabase as o, Route$4 as r, supabaseBrowser as s, Route$16 as t };
