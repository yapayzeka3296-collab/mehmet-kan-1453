...
import { C as Vector2, S as TextureLoader, _ as Raycaster, a as BufferGeometry, b as SphereGeometry, c as InstancedMesh, d as MathUtils, f as Matrix4, g as PlaneGeometry, h as PerspectiveCamera, i as BufferAttribute, l as LineBasicMaterial, m as MeshBasicMaterial, o as Color, p as Mesh, s as Group, t as WebGLRenderer, u as LineSegments, v as SRGBColorSpace, w as Vector3, x as StaticDrawUsage, y as Scene } from "../_libs/three.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-BlGL912Y.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const applyDrag = (dx, dy) => {
			const maxPanX = PARCEL_COLUMNS * TILE_SIZE * .5 - 90;
			const maxPanZ = 1055;
			panX = MathUtils.clamp(panX + dx * .08, -1710, maxPanX);
			panZ = MathUtils.clamp(panZ + dy * .08, -1055, maxPanZ);
		...
		const loadAllWorldData = async () => {
			...
			if (cities.length !== CITY_COUNT) throw new Error("81 il eşleştirmesi tamamlanamadı.");
			...
			for (let start = 0; start < cities.length; start += batchSize) {
				...
				const results = await Promise.all(batch.map((city) => supabaseBrowser.from("parcel_map_public").select("id,parcel_number,status,price,tier,city_name,city_code,layer_number,sector_number,grid_x,grid_y").eq("city_name", city.name).order("grid_y", { ascending: true }).order("grid_x", { ascending: true }).range(0, 999)));
				for (let i = 0; i < results.length; i += 1) {
					const result = results[i];
					if (result.error) throw result.error;
					allParcels.push(...result.data ?? []);
				}
				setWorldLoaded(Math.min(allParcels.length, REAL_PARCEL_COUNT));
			}
			if (allParcels.length !== REAL_PARCEL_COUNT) throw new Error("81.000 gerçek parselin tamamı yüklenemedi. Yüklenen: " + allParcels.length);
			...
			for (let i = 0; i < allParcels.length; i += 1) {
				...
				if (parcel.status === "sold") baseColor.set(16735354);
				else if (parcel.status === "reserved") baseColor.set(16762967);
				else if (parcel.status === "available") baseColor.set(3073702);
				else baseColor.set(9347256);
		...
		const onSelectPointerUp = (event) => {
			...
			const parcel = parcelMesh.userData.parcels?.[hit.instanceId];
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "81 milyonluk MySkyParcel evreninin şu anki 81.000 gerçek parselini keşfet. Açılışta tüm gerçek parseller yüklenir; sürüklediğinde yeni veri beklemezsin." })
				] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "gokyuzu-badge",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "sun-dot" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: worldLoading ? worldLoaded.toLocaleString("tr-TR") + " / " + REAL_PARCEL_COUNT.toLocaleString("tr-TR") + " YÜKLENİYOR" : REAL_PARCEL_COUNT.toLocaleString("tr-TR") + " GERÇEK PARSEL · " + TOTAL_PARCELS.toLocaleString("tr-TR") + " HEDEF" })]
				})]
			}),
			worldLoading && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "Parsel Dünyası hazırlanıyor" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
					worldLoaded.toLocaleString("tr-TR"),
					" / ",
					REAL_PARCEL_COUNT.toLocaleString("tr-TR"),
					" gerçek parsel yükleniyor…"
				] })]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "▦ Açılışta tüm 81.000 gerçek parsel" })
				]
			}),
				...
				children: [
					...
					selectedAd && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							selectedAd.link_url && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: selectedAd.link_url,
								target: "_blank",
								rel: "noreferrer",
								children: "Reklamı ziyaret et"
							})
						]
					}),
