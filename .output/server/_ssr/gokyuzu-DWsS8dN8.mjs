...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-DWsS8dN8.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const applyDrag = (dx, dy) => {
			const maxPanX = 110;
			const maxPanZ = 55;
			panX = MathUtils.clamp(panX + dx * .08, -110, maxPanX);
			panZ = MathUtils.clamp(panZ + dy * .08, -55, maxPanZ);
