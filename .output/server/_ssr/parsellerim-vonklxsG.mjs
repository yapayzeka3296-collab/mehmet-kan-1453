...
import { o as useAuth } from "./router-22p_9W0e.mjs";
import { D as List, G as EllipsisVertical, L as Headphones, R as Grid2x2, S as MapPin, T as Lock, V as FileBadge, et as Calendar, l as Star, m as ShieldCheck, n as X, rt as ArrowRight, z as Globe } from "../_libs/lucide-react.mjs";
...
import { t as UserSidebar } from "./UserSidebar-CbT1NQZ4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parsellerim-vonklxsG.js
...
function Parsellerim() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
											...
											children: [
												...
												/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														className: "btn-gold inline-flex shrink-0 items-center gap-2 rounded-md px-5 py-2.5 text-[11px]",
			...
			selectedParcel && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "fixed inset-0 z-[100] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm",
				role: "dialog",
				"aria-modal": "true",
				"aria-label": "Parsel detayları",
				onMouseDown: (event) => {
					if (event.target === event.currentTarget) setSelectedParcel(null);
				},
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative max-h-[92vh] w-full max-w-2xl overflow-hidden rounded-xl border border-gold/30 bg-background shadow-2xl",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex items-center justify-between border-b border-border px-5 py-4",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "font-display text-xl",
							children: "PARSEL DETAYLARI"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-1 text-xs text-gold",
							children: selectedParcel.parcel_number
						})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => setSelectedParcel(null),
							className: "rounded-md p-2 text-muted-foreground hover:bg-accent hover:text-gold",
							"aria-label": "Parsel detaylarını kapat",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(X, { className: "h-5 w-5" })
						})]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "max-h-[calc(92vh-76px)] overflow-auto p-5",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative overflow-hidden rounded-lg",
								children: [
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											className: "mt-1 font-semibold",
											children: [selectedParcel.city_name || "—", selectedParcel.city_code ? ` (${selectedParcel.city_code})` : ""]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											className: "mt-1 font-semibold",
											children: TIER_LABELS[selectedParcel.tier]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											children: "SATIN ALINDI / SAHİBİSİNİZ"
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											className: "mt-1 font-semibold",
											children: new Date(selectedParcel.created_at).toLocaleDateString("tr-TR")
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											className: "text-[10px] uppercase tracking-wider text-muted-foreground",
											children: "Parsel Fiyatı"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dd", {
											className: "mt-1 font-semibold",
											children: [Number(selectedParcel.tier_price ?? selectedParcel.price).toLocaleString("tr-TR"), " TL"]
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											className: "mt-1 font-semibold",
											children: Number(selectedParcel.latitude).toFixed(6)
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "rounded-lg border border-border p-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", {
											...
											className: "mt-1 font-semibold",
											children: Number(selectedParcel.longitude).toFixed(6)
										})]
									})
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "mt-0.5 h-5 w-5 shrink-0 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "text-sm font-semibold",
												children: "Parsel konumu"
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
												className: "mt-1 text-xs text-muted-foreground",
												children: "Bu kayıt, satın aldığınız parselin sistemdeki koordinatlarını gösterir."
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
												className: "mt-2 text-xs text-gold",
												children: [
													Number(selectedParcel.latitude).toFixed(6),
													", ",
													Number(selectedParcel.longitude).toFixed(6)
												]
											})
										] })]
									})
									...
									type: "button",
									onClick: () => goToMap(selectedParcel),
									className: "btn-gold flex min-h-[110px] items-center justify-center gap-2 rounded-lg px-5 py-3 text-xs font-bold",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(MapPin, { className: "h-5 w-5" }), "KONUMA GİT"]
								})]
							})
						]
					})]
