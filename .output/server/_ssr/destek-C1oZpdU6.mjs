...
import { C as Phone, k as Mail } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/destek-C1oZpdU6.mjs
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "MYSKYPARCEL DESTEK"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "mt-4 font-display text-4xl font-bold sm:text-5xl",
							children: "DESTEK MERKEZİ"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mx-auto mt-5 max-w-2xl text-sm leading-7 text-muted-foreground",
							children: "Sipariş, ödeme, sertifika ve parsel işlemleriyle ilgili destek almak için aşağıdaki kanallardan bize ulaşabilirsiniz."
						}),
