...
import { C as Play, D as Music2, T as Pencil, V as ImagePlus, k as MapPin, l as Trash2, m as ShoppingCart, n as X } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/ParcelDetailPanel-tiy6Emio.mjs
...
function ParcelDetailPanel({ parcel, onClose, onLocate }) {
	...
	const [parcelAd, setParcelAd] = (0, import_react.useState)(null);
	...
	const [adMessage, setAdMessage] = (0, import_react.useState)(null);
	...
	(0, import_react.useEffect)(() => {
		...
		async function loadAdvertisement() {
			const { data, error } = await supabaseBrowser.from("parcel_advertisements").select("id,parcel_id,title,image_path,link_url,is_active").eq("parcel_id", parcel.id).maybeSingle();
			if (cancelled) return;
			if (error) {
				console.error("Parcel advertisement lookup error", error);
				setAdMessage("Reklam bilgisi yüklenemedi.");
				return;
			}
			const nextAd = data ?? null;
			setParcelAd(nextAd);
			setAdTitle(nextAd?.title ?? "");
			setAdLink(nextAd?.link_url ?? "");
		}
		loadAdvertisement();
		return () => {
			cancelled = true;
	...
	async function saveParcelAdvertisement() {
		if (!user || !canManageMemory) {
			setAdMessage("Reklam vermek için bu parselin sahibi olmalısınız.");
			return;
		}
		if (!adFile && !parcelAd) {
			setAdMessage("Lütfen bir reklam görseli seçin.");
			return;
		}
		...
		try {
			...
			setParcelAd(data);
			setAdFile(null);
			setAdMessage("Reklam bu parsele yayınlandı. Parsel Dünyası sayfasında görünür.");
		} catch (error) {
			console.error("Parcel advertisement save error", error);
	...
	async function removeParcelAdvertisement() {
		...
		try {
			...
			if (error) throw error;
			if (parcelAd.image_path) {
				const { error: storageError } = await supabaseBrowser.storage.from("parcel-ads").remove([parcelAd.image_path]);
				if (storageError) console.error("Parcel ad media cleanup error", storageError);
			}
			setParcelAd(null);
			setAdTitle("");
			setAdLink("");
			setAdFile(null);
			setAdMessage("Parsel reklamı kaldırıldı.");
		} catch (error) {
			console.error("Parcel advertisement delete error", error);
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Satın aldığınız parsele ücretsiz reklam verin"
							})] }), parcelAd && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "rounded-full border border-emerald-300/20 px-2 py-1 text-[9px] font-semibold text-emerald-100",
								children: "YAYINDA"
							})]
						}), canManageMemory ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mt-4 space-y-3",
							children: [
								parcelAd && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: getAdUrl(parcelAd),
									alt: "Parsel reklamı",
									className: "max-h-40 w-full rounded-lg object-contain bg-black/20",
									loading: "lazy"
								}),
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											...
											children: [
												...
												" ",
												parcelAd ? "Reklam görselini değiştir" : "Reklam görseli ekle"
											]
										}),
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "mt-1 block text-[10px] text-muted-foreground",
											children: "JPG, PNG, WEBP veya GIF · Maks. 5 MB"
										}),
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										children: "İşletme / reklam adı"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										value: adTitle,
										onChange: (e) => setAdTitle(e.target.value.slice(0, 120)),
										maxLength: 120,
										placeholder: "Örn. Mehmet Kan Cafe",
										className: "mt-2 w-full rounded-lg border border-white/10 bg-white/5 p-2.5 text-xs"
									})]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
									className: "block",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: "text-xs font-semibold",
										children: "Web sitesi (isteğe bağlı)"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
										value: adLink,
										onChange: (e) => setAdLink(e.target.value.slice(0, 500)),
										maxLength: 500,
										placeholder: "https://...",
										className: "mt-2 w-full rounded-lg border border-white/10 bg-white/5 p-2.5 text-xs"
									})]
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: adSaving,
										onClick: () => void saveParcelAdvertisement(),
										className: "btn-gold h-10 rounded-lg text-xs font-bold",
										children: adSaving ? "YAYINLANIYOR..." : parcelAd ? "REKLAMI GÜNCELLE" : "PARSELE REKLAM VER"
									}), parcelAd ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
										type: "button",
										disabled: adSaving,
										onClick: () => void removeParcelAdvertisement(),
										className: "h-10 rounded-lg border border-red-300/20 bg-red-300/5 text-xs font-bold text-red-100",
										children: adSaving ? "İŞLENİYOR..." : "REKLAMI KALDIR"
									}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										className: "flex items-center justify-center rounded-lg border border-white/10 px-2 text-center text-[10px] text-muted-foreground",
										children: "Ücretsiz"
									})]
								})
							]
						}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "mt-4 rounded-lg border border-dashed border-cyan-300/20 bg-white/[0.02] p-4 text-center text-xs text-white/55",
							children: parcelAd ? "Bu parselde aktif reklam bulunuyor." : "Bu parselin sahibi olduğunuzda ücretsiz reklam verebilirsiniz."
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-5 border-t border-white/10 pt-4",
