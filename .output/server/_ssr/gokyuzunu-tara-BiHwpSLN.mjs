...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzunu-tara-BiHwpSLN.mjs
...
function SkyScannerPage() {
	...
	const startScanner = (0, import_react.useCallback)(async () => {
		...
		try {
			...
			if (typeof orientation.requestPermission === "function") {
				if (await orientation.requestPermission() !== "granted") setError("Yön sensörü izni verilmedi. Parseller test görünümünde gösteriliyor.");
			}
	...
	const projected = (0, import_react.useMemo)(() => {
		...
		})).filter(({ projection }) => projection.visible).sort((a, b) => a.projection.distance - b.projection.distance).slice(0, 30);
	}, [
		parcels,
		sensor.location,
		sensor.heading,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				cameraReady && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								" · Yön ",
								sensor.heading != null ? `${Math.round(sensor.heading)}°` : "test görünümü"
							]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							style: {
								padding: "9px 12px",
					...
					parcels.length > 0 && projected.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						style: {
							position: "absolute",
							left: 16,
							right: 16,
						...
						children: "Gerçek parseller bulundu ancak mevcut kamera açısının dışında. Telefonu yavaşça 360° çevir."
					}),
