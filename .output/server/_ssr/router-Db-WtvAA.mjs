...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Db-WtvAA.js
var router_Db_WtvAA_exports = /* @__PURE__ */ __exportAll({
	a: () => Route$21,
	c: () => supabaseBrowser,
	getRouter: () => getRouter,
	i: () => Route$16,
	...
	o: () => useAuth,
	r: () => Route$10,
	s: () => createBrowserSupabase,
	t: () => router_exports
});
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var import_react_dom = require_react_dom();
var styles_default = "/assets/styles-CTnebwge.css";
...
var $$splitComponentImporter$36 = () => import("./routes-DHUQ6s1_.mjs");
...
var Route$40 = createFileRoute("/admin-check")({ server: { handlers: { GET } } });
var $$splitComponentImporter$35 = () => import("./ana-sayfa-CHXrCD_v.mjs");
var Route$39 = createFileRoute("/ana-sayfa")({
...
var $$splitComponentImporter$34 = () => import("./bildirimler-Bd4J7EUf.mjs");
var Route$38 = createFileRoute("/bildirimler")({ component: lazyRouteComponent($$splitComponentImporter$34, "component") });
var $$splitComponentImporter$33 = () => import("./cerez-politikasi-CQt1SlDC.mjs");
var Route$37 = createFileRoute("/cerez-politikasi")({
...
var $$splitComponentImporter$32 = () => import("./dogrula-DGwEmKS2.mjs");
var Route$36 = createFileRoute("/dogrula")({
...
var $$splitComponentImporter$31 = () => import("./giris-DfMYU4-V.mjs");
var Route$35 = createFileRoute("/giris")({
	head: () => ({
		meta: [
...
var $$splitComponentImporter$30 = () => import("./gizlilik-politikasi-DgEZ_dgJ.mjs");
var Route$34 = createFileRoute("/gizlilik-politikasi")({
	head: () => ({ meta: [{ title: "Gizlilik Politikası — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$30, "component")
});
var $$splitComponentImporter$29 = () => import("./gokyuzu-haritasi-DBXQimXA.mjs");
var Route$33 = createFileRoute("/gokyuzu-haritasi")({ component: lazyRouteComponent($$splitComponentImporter$29, "component") });
var $$splitComponentImporter$28 = () => import("./guvenlik-ayarlari-BUNZEugk.mjs");
var Route$32 = createFileRoute("/guvenlik-ayarlari")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$27 = () => import("./hakkimizda-BUKgJWWh.mjs");
var Route$31 = createFileRoute("/hakkimizda")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$26 = () => import("./hediye-kabul-CxpEGyV8.mjs");
var Route$30 = createFileRoute("/hediye-kabul")({
...
var $$splitComponentImporter$25 = () => import("./hediyelerim-Dy3PfY-s.mjs");
var Route$29 = createFileRoute("/hediyelerim")({
...
var $$splitComponentImporter$24 = () => import("./iade-iptal-politikasi-DVWQTtdB.mjs");
var Route$28 = createFileRoute("/iade-iptal-politikasi")({
...
var $$splitComponentImporter$23 = () => import("./iletisim-DetEX8YN.mjs");
var Route$27 = createFileRoute("/iletisim")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$22 = () => import("./kayit-ol-DQYq3iMp.mjs");
var Route$26 = createFileRoute("/kayit-ol")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$21 = () => import("./kullanim-sartlari-vSI5qkve.mjs");
var Route$25 = createFileRoute("/kullanim-sartlari")({
	head: () => ({ meta: [{ title: "Kullanım Şartları — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$21, "component")
});
var $$splitComponentImporter$20 = () => import("./kvkk-DMNoxMBW.mjs");
var Route$24 = createFileRoute("/kvkk")({
...
var $$splitComponentImporter$19 = () => import("./mesafeli-satis-sozlesmesi-CWMaojNm.mjs");
var Route$23 = createFileRoute("/mesafeli-satis-sozlesmesi")({
...
var $$splitComponentImporter$18 = () => import("./nasil-calisir-BxR7SdU0.mjs");
var Route$22 = createFileRoute("/nasil-calisir")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$17 = () => import("./odeme-DuO9CIft.mjs");
var Route$21 = createFileRoute("/odeme")({
...
var $$splitComponentImporter$16 = () => import("./on-bilgilendirme-formu-i2KbyNY4.mjs");
...
var $$splitComponentImporter$15 = () => import("./paketler-CAqXHCDm.mjs");
...
var $$splitComponentImporter$14 = () => import("./panelim-D72M4BNR.mjs");
...
var Route$17 = createFileRoute("/parsel-hatirasi")({ component: ParcelHatirasiPage });
function ParcelHatirasiPage() {
	...
	const [loading, setLoading] = (0, import_react.useState)(true);
	const [error, setError] = (0, import_react.useState)(null);
	const [musicError, setMusicError] = (0, import_react.useState)(null);
	const musicRetryRef = (0, import_react.useRef)(false);
	async function getMusicUrl(path) {
		const { data, error } = await supabaseBrowser.storage.from("parcel-memories").createSignedUrl(path, 3600);
		...
		(async () => {
			try {
				...
				if (memError) setError(memError.message);
					...
					if (next.music_path) try {
						const url = await getMusicUrl(next.music_path);
						if (!cancelled) setMusicUrl(url);
					} catch (musicLoadError) {
						if (!cancelled) setMusicError(musicLoadError instanceof Error ? musicLoadError.message : "Müzik yüklenemedi.");
					}
				}
			} catch (loadError) {
				if (!cancelled) setError(loadError instanceof Error ? loadError.message : "Hatıra yüklenemedi.");
			} finally {
	...
	async function handleMusicError() {
		if (!memory?.music_path || musicRetryRef.current) {
			setMusicError("Müzik tarayıcı tarafından oynatılamadı.");
			return;
		}
		musicRetryRef.current = true;
		setMusicError("Müzik yeniden yükleniyor...");
		try {
			const url = await getMusicUrl(memory.music_path);
			setMusicUrl(url ? `${url}&audio_retry=1` : null);
			setMusicError(null);
		} catch (retryError) {
			setMusicError(retryError instanceof Error ? retryError.message : "Müzik tarayıcı tarafından oynatılamadı.");
		}
	}
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					musicUrl && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("audio", {
								...
								preload: "metadata",
								className: "w-full",
								onError: () => void handleMusicError(),
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("source", {
									src: musicUrl,
									type: "audio/mpeg"
								})
							}, musicUrl),
							musicError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
var $$splitComponentImporter$13 = () => import("./parsel-satin-al-Bi2RSQEE.mjs");
var Route$16 = createFileRoute("/parsel-satin-al")({
	validateSearch: (search) => ({
...
var $$splitComponentImporter$12 = () => import("./parsellerim-BDvKnOL7.mjs");
var Route$15 = createFileRoute("/parsellerim")({
...
var $$splitComponentImporter$11 = () => import("./pazar-yeri-DK5i5sMW.mjs");
var Route$14 = createFileRoute("/pazar-yeri")({
...
var $$splitComponentImporter$10 = () => import("./profilim-CX2v-q5O.mjs");
var Route$13 = createFileRoute("/profilim")({
	head: () => ({ meta: [
...
var Route$12 = createFileRoute("/purchase")({ server: { handlers: { POST: POST$1 } } });
...
var Route$11 = createFileRoute("/purchase-bulk")({ server: { handlers: { POST } } });
var $$splitComponentImporter$9 = () => import("./sertifika-dogrula-Do3pQE_d.mjs");
var Route$10 = createFileRoute("/sertifika-dogrula")({
...
var $$splitComponentImporter$8 = () => import("./sertifika-talep-CBmIK-z4.mjs");
var Route$9 = createFileRoute("/sertifika-talep")({
	head: () => ({ meta: [{ title: "Sertifika Oluştur — MySkyParcel" }] }),
	component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
var $$splitComponentImporter$7 = () => import("./sertifikalarim-Dy1us15K.mjs");
var Route$8 = createFileRoute("/sertifikalarim")({
...
var $$splitComponentImporter$6 = () => import("./sifre-yenile-uJ9CCrRy.mjs");
var Route$7 = createFileRoute("/sifre-yenile")({
...
var $$splitComponentImporter$5 = () => import("./sifremi-unuttum-gO7DRScD.mjs");
var Route$6 = createFileRoute("/sifremi-unuttum")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$4 = () => import("./siparislerim-DSrYp-QY.mjs");
var Route$5 = createFileRoute("/siparislerim")({
	head: () => ({ meta: [
...
var $$splitComponentImporter$3 = () => import("./turkiye-haritasi-BuwBp7Hu.mjs");
var Route$4 = createFileRoute("/turkiye-haritasi")({
	head: () => ({ links: [{
		rel: "preload",
...
var $$splitComponentImporter$2 = () => import("./uyelik-sozlesmesi-DQp47weT.mjs");
var Route$3 = createFileRoute("/uyelik-sozlesmesi")({
...
var $$splitComponentImporter$1 = () => import("./yonetim-Cd-R5U6M.mjs");
var Route$2 = createFileRoute("/yonetim")({
...
var Route$1 = createFileRoute("/api/earth-assets")({ server: { handlers: { GET: async ({ request }) => {
...
var $$splitComponentImporter = () => import("../_slug-CWow076b.mjs");
var Route = createFileRoute("/sehir/$slug")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
var rootRouteChildren = {
	IndexRoute: Route$41.update({
		id: "/",
		path: "/",
		getParentRoute: () => Route$42
	}),
	AdminCheckRoute: Route$40.update({
		id: "/admin-check",
		path: "/admin-check",
		getParentRoute: () => Route$42
	}),
	AnaSayfaRoute: Route$39.update({
		id: "/ana-sayfa",
		path: "/ana-sayfa",
		getParentRoute: () => Route$42
	}),
	BildirimlerRoute: Route$38.update({
		id: "/bildirimler",
		path: "/bildirimler",
		getParentRoute: () => Route$42
	}),
	CerezPolitikasiRoute: Route$37.update({
		id: "/cerez-politikasi",
		path: "/cerez-politikasi",
		getParentRoute: () => Route$42
	}),
	DogrulaRoute: Route$36.update({
		id: "/dogrula",
		path: "/dogrula",
		getParentRoute: () => Route$42
	}),
	GirisRoute: Route$35.update({
		id: "/giris",
		path: "/giris",
		getParentRoute: () => Route$42
	}),
	GizlilikPolitikasiRoute: Route$34.update({
		id: "/gizlilik-politikasi",
		path: "/gizlilik-politikasi",
		getParentRoute: () => Route$42
	}),
	GokyuzuHaritasiRoute: Route$33.update({
		id: "/gokyuzu-haritasi",
		path: "/gokyuzu-haritasi",
		getParentRoute: () => Route$42
	}),
	GuvenlikAyarlariRoute: Route$32.update({
		id: "/guvenlik-ayarlari",
		path: "/guvenlik-ayarlari",
		getParentRoute: () => Route$42
	}),
	HakkimizdaRoute: Route$31.update({
		id: "/hakkimizda",
		path: "/hakkimizda",
		getParentRoute: () => Route$42
	}),
	HediyeKabulRoute: Route$30.update({
		id: "/hediye-kabul",
		path: "/hediye-kabul",
		getParentRoute: () => Route$42
	}),
	HediyelerimRoute: Route$29.update({
		id: "/hediyelerim",
		path: "/hediyelerim",
		getParentRoute: () => Route$42
	}),
	IadeIptalPolitikasiRoute: Route$28.update({
		id: "/iade-iptal-politikasi",
		path: "/iade-iptal-politikasi",
		getParentRoute: () => Route$42
	}),
	IletisimRoute: Route$27.update({
		id: "/iletisim",
		path: "/iletisim",
		getParentRoute: () => Route$42
	}),
	KayitOlRoute: Route$26.update({
		id: "/kayit-ol",
		path: "/kayit-ol",
		getParentRoute: () => Route$42
	}),
	KullanimSartlariRoute: Route$25.update({
		id: "/kullanim-sartlari",
		path: "/kullanim-sartlari",
		getParentRoute: () => Route$42
	}),
	KvkkRoute: Route$24.update({
		id: "/kvkk",
		path: "/kvkk",
		getParentRoute: () => Route$42
	}),
	MesafeliSatisSozlesmesiRoute: Route$23.update({
		id: "/mesafeli-satis-sozlesmesi",
		path: "/mesafeli-satis-sozlesmesi",
		getParentRoute: () => Route$42
	}),
	NasilCalisirRoute: Route$22.update({
		id: "/nasil-calisir",
		path: "/nasil-calisir",
		getParentRoute: () => Route$42
	}),
	OdemeRoute: Route$21.update({
		id: "/odeme",
		path: "/odeme",
		getParentRoute: () => Route$42
	}),
	...
	ParselHatirasiRoute: Route$17.update({
		id: "/parsel-hatirasi",
		path: "/parsel-hatirasi",
		getParentRoute: () => Route$42
	}),
	ParselSatinAlRoute: Route$16.update({
		id: "/parsel-satin-al",
		path: "/parsel-satin-al",
		getParentRoute: () => Route$42
	}),
	ParsellerimRoute: Route$15.update({
		id: "/parsellerim",
		path: "/parsellerim",
		getParentRoute: () => Route$42
	}),
	PazarYeriRoute: Route$14.update({
		id: "/pazar-yeri",
		path: "/pazar-yeri",
		getParentRoute: () => Route$42
	}),
	ProfilimRoute: Route$13.update({
		id: "/profilim",
		path: "/profilim",
		getParentRoute: () => Route$42
	}),
	PurchaseRoute: Route$12.update({
		id: "/purchase",
		path: "/purchase",
		getParentRoute: () => Route$42
	}),
	PurchaseBulkRoute: Route$11.update({
		id: "/purchase-bulk",
		path: "/purchase-bulk",
		getParentRoute: () => Route$42
	}),
	SertifikaDogrulaRoute: Route$10.update({
		id: "/sertifika-dogrula",
		path: "/sertifika-dogrula",
		getParentRoute: () => Route$42
	}),
	SertifikaTalepRoute: Route$9.update({
		id: "/sertifika-talep",
		path: "/sertifika-talep",
		getParentRoute: () => Route$42
	}),
	SertifikalarimRoute: Route$8.update({
		id: "/sertifikalarim",
		path: "/sertifikalarim",
		getParentRoute: () => Route$42
	}),
	SifreYenileRoute: Route$7.update({
		id: "/sifre-yenile",
		path: "/sifre-yenile",
		getParentRoute: () => Route$42
	}),
	SifremiUnuttumRoute: Route$6.update({
		id: "/sifremi-unuttum",
		path: "/sifremi-unuttum",
		getParentRoute: () => Route$42
	}),
	SiparislerimRoute: Route$5.update({
		id: "/siparislerim",
		path: "/siparislerim",
		getParentRoute: () => Route$42
	}),
	TurkiyeHaritasiRoute: Route$4.update({
		id: "/turkiye-haritasi",
		path: "/turkiye-haritasi",
		getParentRoute: () => Route$42
	}),
	UyelikSozlesmesiRoute: Route$3.update({
		id: "/uyelik-sozlesmesi",
		path: "/uyelik-sozlesmesi",
		getParentRoute: () => Route$42
	}),
	YonetimRoute: Route$2.update({
		id: "/yonetim",
		path: "/yonetim",
		getParentRoute: () => Route$42
	}),
	ApiEarthAssetsRoute: Route$1.update({
		id: "/api/earth-assets",
		path: "/api/earth-assets",
		getParentRoute: () => Route$42
	}),
	SehirSlugRoute: Route.update({
		id: "/sehir/$slug",
		path: "/sehir/$slug",
		getParentRoute: () => Route$42
	})
...
//#endregion
export { createBrowserSupabase as a, useAuth as c, Route$21 as i, Route$10 as n, router_Db_WtvAA_exports as o, Route$16 as r, supabaseBrowser as s, Route as t };
