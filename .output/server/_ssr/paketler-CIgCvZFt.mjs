...
import { M as Lock, U as Heart, d as Star, ft as ArrowRight, g as ShieldCheck, ot as Check, tt as CloudDownload } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/paketler-CIgCvZFt.mjs
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
								...
								children: "KİŞİYE ÖZEL DİJİTAL HEDİYE VE SERTİFİKA"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mx-auto mt-4 max-w-3xl text-sm leading-7 text-muted-foreground",
								children: "Kişiye özel hediye, sevgiliye özel hediye, sevgiliye farklı veya ilginç hediye ve dijital hediye arayanlar için Dijital, Özel ve Premium sertifika paketlerini inceleyin."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mx-auto mt-3 max-w-3xl text-sm leading-7 text-muted-foreground",
								children: "Anlamlı ve unutulmaz bir sürpriz için kişiye özel dijital hediye seçebilir, sembolik gökyüzü parselinizi ve sertifika paketinizi oluşturabilirsiniz."
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mx-auto mt-3 max-w-3xl text-sm leading-7 text-muted-foreground",
