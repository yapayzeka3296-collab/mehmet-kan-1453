...
import { o as supabaseBrowser, r as Route$16 } from "./router-CUqG1PTn.mjs";
import { M as LoaderCircle, d as Sparkles, it as Check, q as FileBadge } from "../_libs/lucide-react.mjs";
import { n as SiteHeader, r as readParcelCart } from "./SiteHeader-Cpx76iDo.mjs";
import { t as SiteFooter } from "./SiteFooter-Dv3_EOXG.mjs";
import { n as TrustBar } from "./TrustBar-Ci8UbTsR.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/parsel-satin-al-CAoWaK2l.mjs
...
function SatinAl() {
	...
	const { parcels, certificateParcel: requestedCertificate } = Route$16.useSearch();
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						children: [
							"İstediğiniz sayıda ve farklı türlerde parsel seçebilirsiniz. Bu işlemde yalnızca ",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "mt-5 rounded-md border border-gold/30 bg-gold/[0.04] px-4 py-3 text-center text-xs text-muted-foreground",
									children: "Ödeme altyapısı kaldırıldı. Yeni bir ödeme yöntemi eklenene kadar satın alma işlemi tamamlanamaz."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									type: "button",
									disabled: !accepted || !physicalReady || true,
									className: "mt-3 inline-flex w-full items-center justify-center gap-2 rounded-md border border-border px-6 py-3 text-[11px] opacity-50 cursor-not-allowed",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "h-4 w-4" }), " ÖDEME SİSTEMİ AKTİF DEĞİL"]
								})
							]
