...
import { c as useAuth } from "./router-DJeY1Ycb.mjs";
import { t as Logo } from "./Logo-BeAdC7v8.mjs";
import { D as Menu, W as Globe, h as ShieldCheck, l as Store, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/SiteHeader-Cb4pP_II.js
...
function SiteHeader() {
	...
	const cartButton = (mobile = false) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
			...
			className: "relative p-2 text-slate-300 transition-colors duration-200 hover:text-[#D4AF37]",
			...
			className: `absolute right-0 top-full z-[99999] mt-2 w-[min(380px,calc(100vw-24px))] overflow-hidden rounded-2xl border border-cyan-300/20 bg-slate-950/95 shadow-2xl shadow-black/70 backdrop-blur-xl ring-1 ring-white/5 ${mobile ? "fixed !right-0 !left-auto !top-[80px] !mt-0 !w-[160px] !min-w-0 !max-w-[160px] !translate-x-0 !bg-black max-h-[58vh]" : ""}`,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		className: "sticky top-0 z-[1000] h-[80px] w-full border-b border-[#1E293B] bg-[color:var(--background)]/90 shadow-lg shadow-black/20 backdrop-blur-md",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto flex h-full min-w-0 max-w-7xl items-center gap-3 px-4 sm:gap-4 sm:px-6 lg:gap-5 lg:px-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						title: "Küre",
						className: "group flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-cyan-300/30 bg-slate-900/70 text-cyan-200 transition hover:border-cyan-200/70 hover:bg-cyan-300/10 hover:text-cyan-100",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					className: "hidden min-w-0 flex-1 flex-wrap items-center justify-center gap-x-3 gap-y-1 px-1 xl:flex 2xl:gap-x-4",
					children: [visibleNavLinks.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: item.to,
						hash: "hash" in item ? item.hash : void 0,
						className: "relative shrink-0 whitespace-nowrap text-xs font-medium text-slate-300 transition-colors hover:text-[#D4AF37] 2xl:text-sm",
						children: item.label
					}, `${item.label}-${item.to}`)), isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/yonetim",
						className: "relative flex shrink-0 items-center gap-1.5 whitespace-nowrap text-xs font-semibold text-[#D4AF37]",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShieldCheck, { className: "h-4 w-4" }), " Yönetim"]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "hidden shrink-0 items-center justify-end gap-2 xl:flex 2xl:gap-3",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/pazar-yeri",
							"aria-label": "Pazar Yeri",
							title: "Pazar Yeri",
							className: "flex shrink-0 items-center gap-1.5 whitespace-nowrap p-2 text-xs font-medium text-slate-300 hover:text-[#D4AF37]",
						...
						isAuthenticated ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/panelim",
							className: "shrink-0 rounded-lg border border-slate-700 px-3 py-2 text-sm font-medium text-slate-200 2xl:px-4",
							children: "Panelim"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => void handleSignOut(),
							className: "shrink-0 rounded-lg bg-[#D4AF37] px-3 py-2 text-sm font-semibold text-black 2xl:px-4",
							children: "Çıkış Yap"
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "ml-auto flex shrink-0 items-center gap-2 xl:hidden",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/pazar-yeri",
							"aria-label": "Pazar Yeri",
