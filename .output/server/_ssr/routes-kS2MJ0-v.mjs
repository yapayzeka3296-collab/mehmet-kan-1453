...
import { r as SiteHeader, t as Logo } from "./SiteHeader-DGjz-qkJ.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-kS2MJ0-v.mjs
var import_react = /* @__PURE__ */ __toESM(require_react(), 1);
var import_jsx_runtime = require_jsx_runtime();
var MySkyParcelEarthGlobeSafe = (0, import_react.lazy)(() => import("./MySkyParcelEarthGlobeSafe-D4BaK7vX.mjs").then((module) => ({ default: module.MySkyParcelEarthGlobeSafe })));
function Landing() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_react.Suspense, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(MySkyParcelEarthGlobeSafe, { className: "h-screen rounded-none border-0 bg-transparent shadow-none" })
			}),
