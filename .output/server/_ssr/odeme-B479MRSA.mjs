...
import { i as Route$21, s as supabaseBrowser } from "./router-BmF_bcLa.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/odeme-B479MRSA.js
...
function Odeme() {
	...
	const { parcels, certificateParcel } = Route$21.useSearch();
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Lock, { className: "h-5 w-5 text-gold" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
										...
										children: "SHOPIER İLE ÖDEME"
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-xs text-muted-foreground",
										children: "Kart bilgileri MySkyParcel üzerinde alınmaz. Ödeme, seçtiğiniz paket için Shopier'in güvenli ödeme sayfasında tamamlanır."
									})] })]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								missingLink && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									children: "Seçilen paketlerden en az birinin canlı Shopier ödeme bağlantısı Vercel ortam değişkenine eklenmemiş."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										...
										className: "mt-2",
										children: "Shopier üzerinden tamamlanan ödeme Shopier hesabından takip edilir. Parseller ödeme doğrulanana kadar kesin olarak satılmış kabul edilmez."
									})]
								})
							]
