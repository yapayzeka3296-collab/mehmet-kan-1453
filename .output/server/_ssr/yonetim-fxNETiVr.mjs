...
import { A as LogOut, K as FileText, T as PackageCheck, b as RefreshCw, ct as Award, et as ClipboardList, g as ShieldAlert, h as ShieldCheck, ot as Boxes, r as Users, st as Bell, tt as CircleX } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/yonetim-fxNETiVr.mjs
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("tr", {
				...
				children: columns.map((column) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("td", {
					...
					children: column.endsWith("_at") && row[column] ? new Date(row[column]).toLocaleString("tr-TR") : String(row[column] ?? "—")
				}, column))
			}, row.id ?? index)) })]
