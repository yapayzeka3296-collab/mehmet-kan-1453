...
import { c as useAuth, s as supabaseBrowser } from "./router-hJp5vZHr.mjs";
import { O as MapPin, V as Heart, ft as ArrowLeft, n as X, p as ShoppingCart } from "../_libs/lucide-react.mjs";
import { a as writeParcelCart, i as removeParcelFromCart, r as readParcelCart, t as PARCEL_CART_EVENT } from "./SiteHeader-LGZBIUCo.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/CityParcelLivePage-CUhwcZbK.mjs
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									children: [
										...
										hasMemory && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
											className: "group/memory absolute right-1 top-1 z-[160] flex h-5 w-5 cursor-pointer items-center justify-center rounded-full bg-emerald-400/10 text-emerald-400 drop-shadow-[0_0_6px_rgba(52,211,153,.95)]",
											role: "button",
											tabIndex: 0,
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heart, {
												...
												className: "pointer-events-none absolute right-1/2 top-[-22px] z-[170] -translate-x-1/2 whitespace-nowrap rounded-md border border-emerald-300/20 bg-[#071a2d]/95 px-1.5 py-0.5 text-[8px] font-semibold text-emerald-200 opacity-0 shadow-lg transition-opacity duration-150 group-hover/memory:opacity-100",
