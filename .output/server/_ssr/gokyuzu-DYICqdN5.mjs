...
//#region node_modules/.nitro/vite/services/ssr/assets/gokyuzu-DYICqdN5.mjs
...
function GokyuzuPage() {
	...
	(0, import_react.useEffect)(() => {
		...
		const onSelectPointerUp = (event) => {
			...
			const parcel = (hit ? findParcelObject(hit.object) : null)?.userData?.parcel;
