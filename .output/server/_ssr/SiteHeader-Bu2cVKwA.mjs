...
import { l as useAuth } from "./router-BoHKv01O.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/SiteHeader-Bu2cVKwA.mjs
...
function SiteHeader() {
	...
	const cartButton = (mobile = false) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		className: `relative z-[210] ${mobile ? "translate-x-0" : "-translate-x-1"}`,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						title: "Küre",
						className: "group flex h-9 w-9 items-center justify-center rounded-full border border-cyan-300/30 bg-slate-900/70 text-cyan-200 transition hover:border-cyan-200/70 hover:bg-cyan-300/10 hover:text-cyan-100",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("nav", {
					...
					children: [visibleNavLinks.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						...
						className: "relative whitespace-nowrap text-xs font-medium text-slate-300 transition-colors hover:text-[#D4AF37] 2xl:text-sm",
						children: item.label
					}, `${item.label}-${item.to}`)), isAdmin && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: "/yonetim",
						className: "relative flex items-center gap-1.5 whitespace-nowrap text-xs font-semibold text-[#D4AF37]",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							title: "Pazar Yeri",
							className: "flex items-center gap-1.5 p-2 text-xs font-medium text-slate-300 hover:text-[#D4AF37]",
						...
						isAuthenticated ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							to: "/panelim",
							className: "-translate-x-1 rounded-lg border border-slate-700 px-4 py-2 text-sm font-medium text-slate-200",
							children: "Panelim"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							onClick: () => void handleSignOut(),
							className: "-translate-x-2 rounded-lg bg-[#D4AF37] px-4 py-2 text-sm font-semibold text-black",
							children: "Çıkış Yap"
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				className: "shrink-0 flex flex-col gap-2 border-t border-[#1E293B] pt-3",
